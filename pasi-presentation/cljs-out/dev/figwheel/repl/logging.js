...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__24571_SHARP_){
return parseInt(p1__24571_SHARP_);
}),cljs.core.take.call(null,(3),clojure.string.split.call(null,v,/[^\d]/)))));
}catch (e24572){if((e24572 instanceof Error)){
var e = e24572;
...
var c_24574 = (new goog.debug.Console());
var G__24573_24575 = c_24574.getFormatter();
goog.object.set(G__24573_24575,"showAbsoluteTime",false);

goog.object.set(G__24573_24575,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_24574);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__24576_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__24576_SHARP_);
