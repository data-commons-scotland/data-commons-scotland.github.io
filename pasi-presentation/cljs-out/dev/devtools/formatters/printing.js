...
var len__4829__auto___22786 = arguments.length;
var i__4830__auto___22787 = (0);
while(true){
if((i__4830__auto___22787 < len__4829__auto___22786)){
args__4835__auto__.push((arguments[i__4830__auto___22787]));

var G__22788 = (i__4830__auto___22787 + (1));
i__4830__auto___22787 = G__22788;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22783){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22784,G__22785,seq22783__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22789_SHARP_){
return (!((cljs.core.meta.call(null,p1__22789_SHARP_) == null)));
})))){
...
var map__22790 = opts;
var map__22790__$1 = cljs.core.__destructure_map.call(null,map__22790);
var markup_db = cljs.core.get.call(null,map__22790__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22791){var _e__8918__auto__ = e22791;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e22793){var _e__8918__auto__ = e22793;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22795 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22796 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22796);

try{var map__22797 = opts;
var map__22797__$1 = cljs.core.__destructure_map.call(null,map__22797);
var markup_db = cljs.core.get.call(null,map__22797__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22795);
}});
...
var temp__5751__auto___22801 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___22801)){
var managed_print_level_22802 = temp__5751__auto___22801;
var _STAR_print_level_STAR__orig_val__22799_22803 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22800_22804 = managed_print_level_22802;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22800_22804);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22798_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22798_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22799_22803);
}} else {
job_fn.call(null);
}
