...
if((typeof devtools !== 'undefined') && (typeof devtools.toolbox !== 'undefined') && (typeof devtools.toolbox.t_devtools$toolbox24563 !== 'undefined')){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox24563 = (function (obj,header,style,tag,meta24564){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
(devtools.toolbox.t_devtools$toolbox24563.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24565,meta24564__$1){
var self__ = this;
var _24565__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox24563(self__.obj,self__.header,self__.style,self__.tag,meta24564__$1));
}));

(devtools.toolbox.t_devtools$toolbox24563.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24565){
var self__ = this;
var _24565__$1 = this;
return self__.meta24564;
}));

(devtools.toolbox.t_devtools$toolbox24563.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL);

(devtools.toolbox.t_devtools$toolbox24563.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox24563.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
}));

(devtools.toolbox.t_devtools$toolbox24563.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
(devtools.toolbox.t_devtools$toolbox24563.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta24564","meta24564",-778321323,null)], null);
}));

(devtools.toolbox.t_devtools$toolbox24563.cljs$lang$type = true);

(devtools.toolbox.t_devtools$toolbox24563.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox24563");

(devtools.toolbox.t_devtools$toolbox24563.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write.call(null,writer__4462__auto__,"devtools.toolbox/t_devtools$toolbox24563");
}));

/**
 * Positional factory function for devtools.toolbox/t_devtools$toolbox24563.
 */
devtools.toolbox.__GT_t_devtools$toolbox24563 = (function devtools$toolbox$__GT_t_devtools$toolbox24563(obj__$1,header__$1,style__$1,tag__$1,meta24564){
return (new devtools.toolbox.t_devtools$toolbox24563(obj__$1,header__$1,style__$1,tag__$1,meta24564));
});

}

return (new devtools.toolbox.t_devtools$toolbox24563(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
}));
