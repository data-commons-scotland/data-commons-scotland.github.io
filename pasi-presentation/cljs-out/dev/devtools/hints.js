...
var map__25195 = top_item;
var map__25195__$1 = cljs.core.__destructure_map.call(null,map__25195);
var file = cljs.core.get.call(null,map__25195__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25195__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25195__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25194){var _e = e25194;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___25196 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___25196)){
var seen_errors_25197 = temp__5751__auto___25196;
if(cljs.core.truth_(seen_errors_25197.has(self))){
} else {
seen_errors_25197.add(self);

var temp__5753__auto___25198 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___25198)){
var sense_25199 = temp__5753__auto___25198;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25199)].join(''));
} else {
}
}
} else {
