...
var _STAR_html_mode_STAR__orig_val__9596 = hiccups.runtime._STAR_html_mode_STAR_;
var _STAR_html_mode_STAR__temp_val__9597 = mode;
(hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR__temp_val__9597);

try{return f.call(null);
}finally {(hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR__orig_val__9596);
}});
/**
...
hiccups.runtime.render_attribute = (function hiccups$runtime$render_attribute(p__9598){
var vec__9599 = p__9598;
var name = cljs.core.nth.call(null,vec__9599,(0),null);
var value = cljs.core.nth.call(null,vec__9599,(1),null);
if(value === true){
if(hiccups.runtime.xml_mode_QMARK_.call(null)){
 ...
 */
hiccups.runtime.normalize_element = (function hiccups$runtime$normalize_element(p__9602){
...
var tag = first__9605;
var content = seq__9604__$1;
if((!((((tag instanceof cljs.core.Keyword)) || ((((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))))))){
throw [cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)," is not a valid tag name"].join('');
} else {
}

var vec__9606 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__9606,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__9606,(1),null);
var id = cljs.core.nth.call(null,vec__9606,(2),null);
var class$ = cljs.core.nth.call(null,vec__9606,(3),null);
...
var vec__9609 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__9609,(0),null);
var attrs = cljs.core.nth.call(null,vec__9609,(1),null);
var content = cljs.core.nth.call(null,vec__9609,(2),null);
if(cljs.core.truth_((function (){var or__4223__auto__ = content;
