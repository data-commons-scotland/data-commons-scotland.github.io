...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__42385){
var map__42386 = p__42385;
var map__42386__$1 = cljs.core.__destructure_map(map__42386);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42386__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42386__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__42387 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42387,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42387,(1),null);
...
var method_cache__4656__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4657__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4658__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__42413 = cljs.core.get_global_hierarchy;
return (fexpr__42413.cljs$core$IFn$_invoke$arity$0 ? fexpr__42413.cljs$core$IFn$_invoke$arity$0() : fexpr__42413.call(null));
})());
...
var map__42420 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__42420__$1 = cljs.core.__destructure_map(map__42420);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42420__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42420__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__42425){
...
var schema = map__42429__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42429__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4656__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4657__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4658__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__42430 = cljs.core.get_global_hierarchy;
return (fexpr__42430.cljs$core$IFn$_invoke$arity$0 ? fexpr__42430.cljs$core$IFn$_invoke$arity$0() : fexpr__42430.call(null));
})());
...
})(),(function (){var iter__4564__auto__ = (function spec_tools$swagger$core$iter__42435(s__42436){
...
var c__4562__auto__ = cljs.core.chunk_first(s__42436__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__42438 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__42437 = (0);
while(true){
if((i__42437 < size__4563__auto__)){
var vec__42440 = cljs.core._nth(c__4562__auto__,i__42437);
...
cljs.core.chunk_append(b__42438,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42438),spec_tools$swagger$core$iter__42435(cljs.core.chunk_rest(s__42436__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42438),null);
}
} else {
var vec__42443 = cljs.core.first(s__42436__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42443,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42443,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__42435(cljs.core.rest(s__42436__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__42448){
var vec__42449 = p__42448;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42449,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42449,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__42453,p){
var vec__42454 = p__42453;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42454,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42454,(1),null);
var acc__$1 = vec__42454;
