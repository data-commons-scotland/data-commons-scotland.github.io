...
d3Array){function numbers(values,valueof){var index,$jscomp$iter$107,$jscomp$key$value,value$441,$jscomp$iter$106,value;return $jscomp.generator.createGenerator(numbers,function($jscomp$generator$context){switch($jscomp$generator$context.nextAddress){case 1:if(null==valueof){$jscomp$generator$context.jumpTo(2);break}index=-1;$jscomp$iter$107=$jscomp.makeIterator(values);$jscomp$key$value=$jscomp$iter$107.next();case 4:if($jscomp$key$value.done){$jscomp$generator$context.jumpTo(0);break}value$441=
$jscomp$key$value.value;value$441=valueof(value$441,++index,values);if(!(null!=value$441&&""!==value$441&&(value$441=+value$441)>=value$441)){$jscomp$generator$context.jumpTo(5);break}return $jscomp$generator$context.yield(value$441,5);case 5:$jscomp$key$value=$jscomp$iter$107.next();$jscomp$generator$context.jumpTo(4);break;case 2:$jscomp$iter$106=$jscomp.makeIterator(values),$jscomp$key$value=$jscomp$iter$106.next();case 9:if($jscomp$key$value.done){$jscomp$generator$context.jumpTo(0);break}value=
