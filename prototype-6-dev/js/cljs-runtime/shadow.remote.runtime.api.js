...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30562 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30562(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30563 = (function (runtime,key,spec){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30563(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30564 = (function (runtime,key){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30564(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30592 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30592(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30644 = (function (runtime,input,callback){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30644(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30648 = (function (runtime,code){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30648(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30545,callback){
var map__30546 = p__30545;
var map__30546__$1 = cljs.core.__destructure_map(map__30546);
var input = map__30546__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30546__$1,new cljs.core.Keyword(null,"code","code",1586293142));
