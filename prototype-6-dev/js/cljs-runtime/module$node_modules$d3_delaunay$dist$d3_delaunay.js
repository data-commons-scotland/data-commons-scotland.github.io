...
this._hullNext=new Uint32Array(n);this._hullTri=new Uint32Array(n);this._hullHash=(new Int32Array(this._hashSize)).fill(-1);this._ids=new Uint32Array(n);this._dists=new Float64Array(n);this.update()};Delaunator.from=function(points,getX,getY){getX=void 0===getX?defaultGetX:getX;getY=void 0===getY?defaultGetY:getY;for(var n=points.length,coords=new Float64Array(2*n),i=0;i<n;i++){var p=points[i];coords[2*i]=getX(p);coords[2*i+1]=getY(p)}return new Delaunator(coords)};Delaunator.prototype.update=function(){for(var JSCompiler_object_inline_x_4294,
JSCompiler_object_inline_y_4295,coords=this.coords,hullPrev=this._hullPrev,hullNext=this._hullNext,hullTri=this._hullTri,hullHash=this._hullHash,n=coords.length>>1,minX=Infinity,minY=Infinity,maxX=-Infinity,maxY=-Infinity,i=0;i<n;i++){var x=coords[2*i];JSCompiler_object_inline_x_4294=coords[2*i+1];x<minX&&(minX=x);JSCompiler_object_inline_x_4294<minY&&(minY=JSCompiler_object_inline_x_4294);x>maxX&&(maxX=x);JSCompiler_object_inline_x_4294>maxY&&(maxY=JSCompiler_object_inline_x_4294);this._ids[i]=i}maxX=
(minX+maxX)/2;minY=(minY+maxY)/2;minX=Infinity;for(maxY=0;maxY<n;maxY++)if(i=dist(maxX,minY,coords[2*maxY],coords[2*maxY+1]),i<minX){var i0=maxY;minX=i}minY=coords[2*i0];maxY=coords[2*i0+1];minX=Infinity;for(maxX=0;maxX<n;maxX++)if(maxX!==i0&&(i=dist(minY,maxY,coords[2*maxX],coords[2*maxX+1]),i<minX&&0<i)){var i1=maxX;minX=i}minX=coords[2*i1];maxX=coords[2*i1+1];JSCompiler_object_inline_x_4294=Infinity;for(i=0;i<n;i++)if(i!==i0&&i!==i1){x=minX-minY;var dy=maxX-maxY;JSCompiler_object_inline_y_4295=
coords[2*i]-minY;var ey=coords[2*i+1]-maxY,bl=x*x+dy*dy,cl=JSCompiler_object_inline_y_4295*JSCompiler_object_inline_y_4295+ey*ey,d=.5/(x*ey-dy*JSCompiler_object_inline_y_4295);dy=(ey*bl-dy*cl)*d;x=(x*cl-JSCompiler_object_inline_y_4295*bl)*d;x=dy*dy+x*x;if(x<JSCompiler_object_inline_x_4294){var i2=i;JSCompiler_object_inline_x_4294=x}}i=coords[2*i2];x=coords[2*i2+1];if(Infinity===JSCompiler_object_inline_x_4294){for(hullNext=0;hullNext<n;hullNext++)this._dists[hullNext]=coords[2*hullNext]-coords[0]||
coords[2*hullNext+1]-coords[1];quicksort(this._ids,this._dists,0,n-1);hullNext=new Uint32Array(n);hullPrev=coords=0;for(hullTri=-Infinity;hullPrev<n;hullPrev++)hullHash=this._ids[hullPrev],this._dists[hullHash]>hullTri&&(hullNext[coords++]=hullHash,hullTri=this._dists[hullHash]);this.hull=hullNext.subarray(0,coords);this.triangles=new Uint32Array(0);this.halfedges=new Uint32Array(0)}else{orient(minY,maxY,minX,maxX,i,x)&&(JSCompiler_object_inline_x_4294=i1,JSCompiler_object_inline_y_4295=minX,bl=maxX,
i1=i2,minX=i,maxX=x,i2=JSCompiler_object_inline_x_4294,i=JSCompiler_object_inline_y_4295,x=bl);JSCompiler_object_inline_y_4295=minX-minY;JSCompiler_object_inline_x_4294=maxX-maxY;bl=i-minY;ey=x-maxY;cl=JSCompiler_object_inline_y_4295*JSCompiler_object_inline_y_4295+JSCompiler_object_inline_x_4294*JSCompiler_object_inline_x_4294;d=bl*bl+ey*ey;dy=.5/(JSCompiler_object_inline_y_4295*ey-JSCompiler_object_inline_x_4294*bl);JSCompiler_object_inline_x_4294=minY+(ey*cl-JSCompiler_object_inline_x_4294*d)*
dy;JSCompiler_object_inline_y_4295=maxY+(JSCompiler_object_inline_y_4295*d-bl*cl)*dy;this._cx=JSCompiler_object_inline_x_4294;this._cy=JSCompiler_object_inline_y_4295;for(bl=0;bl<n;bl++)this._dists[bl]=dist(coords[2*bl],coords[2*bl+1],JSCompiler_object_inline_x_4294,JSCompiler_object_inline_y_4295);quicksort(this._ids,this._dists,0,n-1);this._hullStart=i0;n=3;hullNext[i0]=hullPrev[i2]=i1;hullNext[i1]=hullPrev[i0]=i2;hullNext[i2]=hullPrev[i1]=i0;hullTri[i0]=0;hullTri[i1]=1;hullTri[i2]=2;hullHash.fill(-1);
hullHash[this._hashKey(minY,maxY)]=i0;hullHash[this._hashKey(minX,maxX)]=i1;hullHash[this._hashKey(i,x)]=i2;this.trianglesLen=0;this._addTriangle(i0,i1,i2,-1,-1,-1);minY=0;for(minX=maxY=void 0;minY<this._ids.length;minY++)if(maxX=this._ids[minY],i=coords[2*maxX],x=coords[2*maxX+1],!(0<minY&&Math.abs(i-maxY)<=EPSILON&&Math.abs(x-minX)<=EPSILON)&&(maxY=i,minX=x,maxX!==i0&&maxX!==i1&&maxX!==i2)){JSCompiler_object_inline_y_4295=JSCompiler_object_inline_x_4294=0;for(bl=this._hashKey(i,x);JSCompiler_object_inline_y_4295<
this._hashSize&&(JSCompiler_object_inline_x_4294=hullHash[(bl+JSCompiler_object_inline_y_4295)%this._hashSize],-1===JSCompiler_object_inline_x_4294||JSCompiler_object_inline_x_4294===hullNext[JSCompiler_object_inline_x_4294]);JSCompiler_object_inline_y_4295++);JSCompiler_object_inline_y_4295=JSCompiler_object_inline_x_4294=hullPrev[JSCompiler_object_inline_x_4294];for(bl=void 0;bl=hullNext[JSCompiler_object_inline_y_4295],!orient(i,x,coords[2*JSCompiler_object_inline_y_4295],coords[2*JSCompiler_object_inline_y_4295+
1],coords[2*bl],coords[2*bl+1]);)if(JSCompiler_object_inline_y_4295=bl,JSCompiler_object_inline_y_4295===JSCompiler_object_inline_x_4294){JSCompiler_object_inline_y_4295=-1;break}if(-1!==JSCompiler_object_inline_y_4295){cl=this._addTriangle(JSCompiler_object_inline_y_4295,maxX,hullNext[JSCompiler_object_inline_y_4295],-1,-1,hullTri[JSCompiler_object_inline_y_4295]);hullTri[maxX]=this._legalize(cl+2);hullTri[JSCompiler_object_inline_y_4295]=cl;n++;for(d=hullNext[JSCompiler_object_inline_y_4295];bl=
hullNext[d],orient(i,x,coords[2*d],coords[2*d+1],coords[2*bl],coords[2*bl+1]);)cl=this._addTriangle(d,maxX,bl,hullTri[maxX],-1,hullTri[d]),hullTri[maxX]=this._legalize(cl+2),hullNext[d]=d,n--,d=bl;if(JSCompiler_object_inline_y_4295===JSCompiler_object_inline_x_4294)for(;bl=hullPrev[JSCompiler_object_inline_y_4295],orient(i,x,coords[2*bl],coords[2*bl+1],coords[2*JSCompiler_object_inline_y_4295],coords[2*JSCompiler_object_inline_y_4295+1]);)cl=this._addTriangle(bl,maxX,JSCompiler_object_inline_y_4295,
-1,hullTri[JSCompiler_object_inline_y_4295],hullTri[bl]),this._legalize(cl+2),hullTri[bl]=cl,hullNext[JSCompiler_object_inline_y_4295]=JSCompiler_object_inline_y_4295,n--,JSCompiler_object_inline_y_4295=bl;this._hullStart=hullPrev[maxX]=JSCompiler_object_inline_y_4295;hullNext[JSCompiler_object_inline_y_4295]=hullPrev[d]=maxX;hullNext[maxX]=d;hullHash[this._hashKey(i,x)]=maxX;hullHash[this._hashKey(coords[2*JSCompiler_object_inline_y_4295],coords[2*JSCompiler_object_inline_y_4295+1])]=JSCompiler_object_inline_y_4295}}this.hull=
...
context);return buffer&&buffer.value()};Voronoi.prototype.renderBounds=function(context){var buffer=null==context?context=new Path:void 0;context.rect(this.xmin,this.ymin,this.xmax-this.xmin,this.ymax-this.ymin);return buffer&&buffer.value()};Voronoi.prototype.renderCell=function(i,context){var buffer=null==context?context=new Path:void 0;i=this._clip(i);if(null!==i&&i.length){context.moveTo(i[0],i[1]);for(var n=i.length;i[0]===i[n-2]&&i[1]===i[n-1]&&1<n;)n-=2;for(var i$515=2;i$515<n;i$515+=2)i[i$515]===
i[i$515-2]&&i[i$515+1]===i[i$515-1]||context.lineTo(i[i$515],i[i$515+1]);context.closePath();return buffer&&buffer.value()}};Voronoi.prototype.cellPolygons=function $jscomp$generator$function(){var $jscomp$generator$this=this,$jscomp$destructuring$var71,$jscomp$destructuring$var72,points,i,n,cell;return $jscomp.generator.createGenerator($jscomp$generator$function,function($jscomp$generator$context){switch($jscomp$generator$context.nextAddress){case 1:$jscomp$destructuring$var71=$jscomp$generator$this,
...
points[2*d+1],points[2*f],points[2*f+1]];d=1E-8*Math.hypot(d[3]-d[1],d[2]-d[0]);f=0;for(var n=points.length/2;f<n;++f){var p=jitter(points[2*f],points[2*f+1],d);points[2*f]=p[0];points[2*f+1]=p[1]}this._delaunator=new Delaunator(points)}else delete this.collinear;p=this.halfedges=this._delaunator.halfedges;d=this.hull=this._delaunator.hull;var triangles=this.triangles=this._delaunator.triangles;f=this.inedges.fill(-1);n=this._hullIndex.fill(-1);for(var e$518=0,n$519=p.length;e$518<n$519;++e$518){var p$520=
triangles[2===e$518%3?e$518-2:e$518+1];if(-1===p[e$518]||-1===f[p$520])f[p$520]=e$518}p=0;for(triangles=d.length;p<triangles;++p)n[d[p]]=p;2>=d.length&&0<d.length&&(this.triangles=(new Int32Array(3)).fill(-1),this.halfedges=(new Int32Array(3)).fill(-1),this.triangles[0]=d[0],this.triangles[1]=d[1],this.triangles[2]=d[1],f[d[0]]=1,2===d.length&&(f[d[1]]=0))};Delaunay.prototype.voronoi=function(bounds){return new Voronoi(this,bounds)};Delaunay.prototype.neighbors=function $jscomp$generator$function(i){var $jscomp$generator$this=
...
null==context?context=new Path:void 0,hull=this.hull,points=this.points,h=2*hull[0],n=hull.length;context.moveTo(points[h],points[h+1]);for(h=1;h<n;++h){var h$523=2*hull[h];context.lineTo(points[h$523],points[h$523+1])}context.closePath();return buffer&&buffer.value()};Delaunay.prototype.hullPolygon=function(){var polygon=new Polygon;this.renderHull(polygon);return polygon.value()};Delaunay.prototype.renderTriangle=function(i,context){var buffer=null==context?context=new Path:void 0,points=this.points,
