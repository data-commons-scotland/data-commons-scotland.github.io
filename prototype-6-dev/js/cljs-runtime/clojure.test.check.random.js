...
var clojure$test$check$random$IRandom$rand_long$dyn_36113 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_36113(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_36129 = (function (rng){
var x__4463__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_36129(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_36139 = (function (rng){
var x__4463__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_36139(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_36140 = (function (rng,n){
var x__4463__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_36140(rng,n);
}
});
...
var G__36087 = z;
if(((24) > (function (){var G__36088 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__36088) : clojure.test.check.random.longs.bit_count.call(null,G__36088));
})())){
return clojure.test.check.random.longs.bit_xor(G__36087,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__36087;
}
});
...
var G__36164 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__36165 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__36164;
ret = G__36165;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__36097){
var map__36098 = p__36097;
var map__36098__$1 = cljs.core.__destructure_map(map__36098);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36098__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__36099 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36099,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36099,(1),null);
