...
function(sign){return function(x){return sign*Math.exp(x)}},log=function(sign){return function(x){return Math.log(sign*x)}},symlog=function(c){return function(x){return Math.sign(x)*Math.log1p(Math.abs(x/c))}},symexp=function(c){return function(x){return Math.sign(x)*Math.expm1(Math.abs(x))*c}},pow=function(exponent){return function(x){return 0>x?-Math.pow(-x,exponent):Math.pow(x,exponent)}},ascending=function(u,v){return(u<v||null==u)&&null!=v?-1:(u>v||null==v)&&null!=u?1:(v=v instanceof Date?+v:
...
{},size=0,key$385;for(key$385 in obj){var value=obj[key$385];value===NULL||test&&test(value)||(next[key$385]=value,++size)}map.size=size;map.empty=0;map.object=obj=next}};input&&Object.keys(input).forEach(function(key){map.set(key,input[key])});return map};exports.field=field;exports.flush=function(range,value,threshold,left,right,center){if(!threshold&&0!==threshold)return center;threshold=+threshold;var a=range[0],b=peek(range);b<a&&(range=a,a=b,b=range);range=Math.abs(value-a);value=Math.abs(b-
value);return range<value&&range<=threshold?left:value<=threshold?right:center};exports.hasOwnProperty=has;exports.id=id;exports.identity=identity;exports.inherits=function(child,parent,members){parent=child.prototype=Object.create(parent.prototype);Object.defineProperty(parent,"constructor",{value:child,writable:!0,enumerable:!0,configurable:!0});return extend(parent,members)};exports.inrange=function(value,range,left,right){var r0=range[0];range=range[range.length-1];if(r0>range){var t=r0;r0=range;
range=t}return(void 0===left||left?r0<=value:r0<value)&&(void 0===right||right?value<=range:value<range)};exports.isArray=isArray;exports.isBoolean=function(_){return"boolean"===typeof _};exports.isDate=isDate;exports.isFunction=isFunction;exports.isIterable=function(_){return _&&isFunction(_[Symbol.iterator])};exports.isNumber=isNumber;exports.isObject=isObject;exports.isRegExp=function(_){return"[object RegExp]"===Object.prototype.toString.call(_)};exports.isString=isString;exports.key=function(fields,
flat,opt){fields&&(fields=flat?array$jscomp$0(fields).map(function(f){return f.replace(/\\(.)/g,"$1")}):array$jscomp$0(fields));var len=fields&&fields.length,gen=opt&&opt.get||getter;opt=function(f){return gen(flat?[f]:splitAccessPath(f))};if(len)if(1===len){var get=opt(fields[0]);opt=function(_){return""+get(_)}}else{var get$386=fields.map(opt);opt=function(_){for(var s=""+get$386[0](_),i=0;++i<len;)s+="|"+get$386[i](_);return s}}else opt=function(){return""};return accessor(opt,fields,"key")};exports.lerp=
function(array,frac){var lo=array[0];array=peek(array);return(frac=+frac)?1===frac?array:lo+frac*(array-lo):lo};exports.logger=function(_$jscomp$0,method){var level=_$jscomp$0||0;return{level:function(_){return arguments.length?(level=+_,this):level},error:function(){1<=level&&log$1(method||"error","ERROR",arguments);return this},warn:function(){2<=level&&log$1(method||"warn","WARN",arguments);return this},info:function(){3<=level&&log$1(method||"log","INFO",arguments);return this},debug:function(){4<=
level&&log$1(method||"log","DEBUG",arguments);return this}}};exports.lruCache=function(maxsize){maxsize=+maxsize||1E4;var curr,prev,size,clear=function(){curr={};prev={};size=0},update=function(key,value){++size>maxsize&&(prev=curr,curr={},size=1);return curr[key]=value};clear();return{clear:clear,has:function(key){return has(curr,key)||has(prev,key)},get:function(key){return has(curr,key)?curr[key]:has(prev,key)?update(key,prev[key]):void 0},set:function(key,value){return has(curr,key)?curr[key]=
value:update(key,value)}}};exports.merge=function(compare,array0,array1,output){var n0=array0.length,n1=array1.length;if(!n1)return array0;if(!n0)return array1;output=output||new array0.constructor(n0+n1);for(var i0=0,i1=0,i=0;i0<n0&&i1<n1;++i)output[i]=0<compare(array0[i0],array1[i1])?array1[i1++]:array0[i0++];for(;i0<n0;++i0,++i)output[i]=array0[i0];for(;i1<n1;++i1,++i)output[i]=array1[i1];return output};exports.mergeConfig=function(configs){for(var $jscomp$restParams=[],$jscomp$restIndex=0;$jscomp$restIndex<
arguments.length;++$jscomp$restIndex)$jscomp$restParams[$jscomp$restIndex-0]=arguments[$jscomp$restIndex];return $jscomp$restParams.reduce(function(out,source){for(var key$384 in source)"signals"===key$384?out.signals=mergeNamed(out.signals,source.signals):writeConfig(out,key$384,source[key$384],"legend"===key$384?{layout:1}:"style"===key$384?!0:null);return out},{})};exports.one=one;exports.pad=function(str,length,padchar,align){padchar=padchar||" ";str+="";length-=str.length;return 0>=length?str:
"left"===align?repeat(padchar,length)+str:"center"===align?repeat(padchar,~~(length/2))+str+repeat(padchar,Math.ceil(length/2)):str+repeat(padchar,length)};exports.panLinear=function(domain,delta){return pan(domain,delta,toNumber,identity)};exports.panLog=function(domain,delta){var sign=Math.sign(domain[0]);return pan(domain,delta,log(sign),exp(sign))};exports.panPow=function(domain,delta,exponent){return pan(domain,delta,pow(exponent),pow(1/exponent))};exports.panSymlog=function(domain,delta,constant){return pan(domain,
delta,symlog(constant),symexp(constant))};exports.peek=peek;exports.quarter=function(date){return 1+~~((new Date(date)).getMonth()/3)};exports.repeat=repeat;exports.span=function(array){return array&&peek(array)-array[0]||0};exports.splitAccessPath=splitAccessPath;exports.stringValue=$;exports.toBoolean=function(_){return null==_||""===_?null:_&&"false"!==_&&"0"!==_?!!_:!1};exports.toDate=function(_,parser){parser=parser||defaultParser;return null==_||""===_?null:parser(_)};exports.toNumber=toNumber;
exports.toSet=function(_){for(var s={},n=_.length,i=0;i<n;++i)s[_[i]]=!0;return s};exports.toString=function(_){return null==_||""===_?null:_+""};exports.truncate=function(str,length,align,ellipsis){ellipsis=null!=ellipsis?ellipsis:"…";str+="";var n=str.length,l=Math.max(0,length-ellipsis.length);return n<=length?str:"left"===align?ellipsis+str.slice(n-l):"center"===align?str.slice(0,Math.ceil(l/2))+ellipsis+str.slice(n-~~(l/2)):str.slice(0,l)+ellipsis};exports.truthy=truthy;exports.utcquarter=function(date){return 1+
~~((new Date(date)).getUTCMonth()/3)};exports.visitArray=function(array,filter,visitor){if(array)if(filter)for(var n=array.length,i=0;i<n;++i){var t=filter(array[i]);t&&visitor(t,i,array)}else array.forEach(visitor)};exports.writeConfig=writeConfig;exports.zero=zero;exports.zoomLinear=function(domain,anchor,scale){return zoom(domain,anchor,scale,toNumber,identity)};exports.zoomLog=function(domain,anchor,scale){var sign=Math.sign(domain[0]);return zoom(domain,anchor,scale,log(sign),exp(sign))};exports.zoomPow=
function(domain,anchor,scale,exponent){return zoom(domain,anchor,scale,pow(exponent),pow(1/exponent))};exports.zoomSymlog=function(domain,anchor,scale,constant){return zoom(domain,anchor,scale,symlog(constant),symexp(constant))};Object.defineProperty(exports,"__esModule",{value:!0})})}
