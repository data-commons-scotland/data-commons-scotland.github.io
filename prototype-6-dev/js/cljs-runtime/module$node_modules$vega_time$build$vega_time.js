...
UNITS=TIME_UNITS.reduce(function(o,u,i){return o[u]=1+i,o},{}),$jscomp$compprop4={},defaultSpecifiers=($jscomp$compprop4.year="%Y ",$jscomp$compprop4.quarter="Q%q ",$jscomp$compprop4.month="%b ",$jscomp$compprop4.date="%d ",$jscomp$compprop4.week="W%U ",$jscomp$compprop4.day="%a ",$jscomp$compprop4.dayofyear="%j ",$jscomp$compprop4.hours="%H:00",$jscomp$compprop4.minutes="00:%M",$jscomp$compprop4.seconds=":%S",$jscomp$compprop4.milliseconds=".%L",$jscomp$compprop4["year-month"]="%Y-%m ",$jscomp$compprop4["year-month-date"]=
"%Y-%m-%d ",$jscomp$compprop4["hours-minutes"]="%H:%M",$jscomp$compprop4),t0=new Date;$jscomp$compprop4={};var localGet=($jscomp$compprop4.year=function(d){return d.getFullYear()},$jscomp$compprop4.quarter=function(d){return Math.floor(d.getMonth()/3)},$jscomp$compprop4.month=function(d){return d.getMonth()},$jscomp$compprop4.date=function(d){return d.getDate()},$jscomp$compprop4.hours=function(d){return d.getHours()},$jscomp$compprop4.minutes=function(d){return d.getMinutes()},$jscomp$compprop4.seconds=
function(d){return d.getSeconds()},$jscomp$compprop4.milliseconds=function(d){return d.getMilliseconds()},$jscomp$compprop4.dayofyear=function(d){return localDayOfYear(d)},$jscomp$compprop4.week=function(d){return localWeekNum(d)},$jscomp$compprop4.weekday=function(d,y){return weekday(localWeekNum(d),d.getDay(),localYear(y).getDay())},$jscomp$compprop4.day=function(d,y){return weekday(1,d.getDay(),localYear(y).getDay())},$jscomp$compprop4);$jscomp$compprop4={};var localInv=($jscomp$compprop4.quarter=
function(q){return 3*q},$jscomp$compprop4.week=function(w,y){return weekday(w,0,localYear(y).getDay())},$jscomp$compprop4);$jscomp$compprop4={};var utcGet=($jscomp$compprop4.year=function(d){return d.getUTCFullYear()},$jscomp$compprop4.quarter=function(d){return Math.floor(d.getUTCMonth()/3)},$jscomp$compprop4.month=function(d){return d.getUTCMonth()},$jscomp$compprop4.date=function(d){return d.getUTCDate()},$jscomp$compprop4.hours=function(d){return d.getUTCHours()},$jscomp$compprop4.minutes=function(d){return d.getUTCMinutes()},
$jscomp$compprop4.seconds=function(d){return d.getUTCSeconds()},$jscomp$compprop4.milliseconds=function(d){return d.getUTCMilliseconds()},$jscomp$compprop4.dayofyear=function(d){return utcDayOfYear(d)},$jscomp$compprop4.week=function(d){return utcWeekNum(d)},$jscomp$compprop4.day=function(d,y){return weekday(1,d.getUTCDay(),utcFirst(y))},$jscomp$compprop4.weekday=function(d,y){return weekday(utcWeekNum(d),d.getUTCDay(),utcFirst(y))},$jscomp$compprop4);$jscomp$compprop4={};var utcInv=($jscomp$compprop4.quarter=
function(q){return 3*q},$jscomp$compprop4.week=function(w,y){return weekday(w,0,utcFirst(y))},$jscomp$compprop4);$jscomp$compprop4={};var timeIntervals=($jscomp$compprop4.year=d3Time.timeYear,$jscomp$compprop4.quarter=d3Time.timeMonth.every(3),$jscomp$compprop4.month=d3Time.timeMonth,$jscomp$compprop4.week=d3Time.timeWeek,$jscomp$compprop4.date=d3Time.timeDay,$jscomp$compprop4.day=d3Time.timeDay,$jscomp$compprop4.dayofyear=d3Time.timeDay,$jscomp$compprop4.hours=d3Time.timeHour,$jscomp$compprop4.minutes=
d3Time.timeMinute,$jscomp$compprop4.seconds=d3Time.timeSecond,$jscomp$compprop4.milliseconds=d3Time.timeMillisecond,$jscomp$compprop4);$jscomp$compprop4={};var utcIntervals=($jscomp$compprop4.year=d3Time.utcYear,$jscomp$compprop4.quarter=d3Time.utcMonth.every(3),$jscomp$compprop4.month=d3Time.utcMonth,$jscomp$compprop4.week=d3Time.utcWeek,$jscomp$compprop4.date=d3Time.utcDay,$jscomp$compprop4.day=d3Time.utcDay,$jscomp$compprop4.dayofyear=d3Time.utcDay,$jscomp$compprop4.hours=d3Time.utcHour,$jscomp$compprop4.minutes=
d3Time.utcMinute,$jscomp$compprop4.seconds=d3Time.utcSecond,$jscomp$compprop4.milliseconds=d3Time.utcMillisecond,$jscomp$compprop4),Milli="year month date hours minutes seconds milliseconds".split(" ");$jscomp$compprop4=Milli.slice(0,-1);var Minutes=$jscomp$compprop4.slice(0,-1),Hours=Minutes.slice(0,-1),Day=Hours.slice(0,-1),Month=["year","month"],Year=["year"],intervals=[[$jscomp$compprop4,1,1E3],[$jscomp$compprop4,5,5E3],[$jscomp$compprop4,15,15E3],[$jscomp$compprop4,30,3E4],[Minutes,1,6E4],[Minutes,
