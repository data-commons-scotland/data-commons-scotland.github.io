...
var G__21547 = o;
reagent.impl.template.goog$module$goog$object.set(G__21547,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__21685__delegate = function (args){
...
while (G__21686__i < G__21686__a.length) {G__21686__a[G__21686__i] = arguments[G__21686__i + 0]; ++G__21686__i;}
  args = new cljs.core.IndexedSeq(G__21686__a,0,null);
} 
return G__21685__delegate.call(this,args);};
G__21685.cljs$lang$maxFixedArity = 0;
G__21685.cljs$lang$applyTo = (function (arglist__21687){
var args = cljs.core.seq(arglist__21687);
return G__21685__delegate(args);
});
...
var G__21557 = o;
reagent.impl.template.goog$module$goog$object.set(G__21557,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__21689__i < G__21689__a.length) {G__21689__a[G__21689__i] = arguments[G__21689__i + 0]; ++G__21689__i;}
  args = new cljs.core.IndexedSeq(G__21689__a,0,null);
} 
...
var G__21604 = props;
var G__21604__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21604,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21604);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21604__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21619 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21619,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21619;
}
})(),id_class);
...
var G__21626 = (cljs.core.count(argv) - first_child);
switch (G__21626) {
case (0):
...
var vec__21632 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21632,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21632,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21632,(2),null);
...
var temp__5757__auto___21692 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___21692 == null)){
} else {
var key_21693 = temp__5757__auto___21692;
(jsprops.key = key_21693);
}
...
var temp__5757__auto___21694 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___21694 == null)){
} else {
var key_21695 = temp__5757__auto___21694;
(jsprops.key = key_21695);
}
...
var temp__5757__auto___21696 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___21696 == null)){
} else {
var key_21697 = temp__5757__auto___21696;
(jsprops.key = key_21697);
}
...
var temp__5757__auto___21698 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___21698 == null)){
} else {
var key_21699 = temp__5757__auto___21698;
(jsprops.key = key_21699);
}
...
var temp__5757__auto___21700 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___21700 == null)){
} else {
var key_21701 = temp__5757__auto___21700;
(jsprops.key = key_21701);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21647_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21647_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21648 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21648,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21648,(1),null);
...
break;
default:
var G__21703 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21704 = compiler;
v = G__21703;
compiler = G__21704;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21658 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21658 = (function (opts,id,fn_to_element,meta21659){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21658.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21660,meta21659__$1){
var self__ = this;
var _21660__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21658(self__.opts,self__.id,self__.fn_to_element,meta21659__$1));
}));

(reagent.impl.template.t_reagent$impl$template21658.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21660){
var self__ = this;
var _21660__$1 = this;
return self__.meta21659;
}));

(reagent.impl.template.t_reagent$impl$template21658.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21658.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21658.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21658.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21658.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta21659","meta21659",-37399482,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21658.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21658.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21658");

(reagent.impl.template.t_reagent$impl$template21658.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template21658");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21658.
 */
reagent.impl.template.__GT_t_reagent$impl$template21658 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21658(opts__$1,id__$1,fn_to_element__$1,meta21659){
return (new reagent.impl.template.t_reagent$impl$template21658(opts__$1,id__$1,fn_to_element__$1,meta21659));
});

}

return (new reagent.impl.template.t_reagent$impl$template21658(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
