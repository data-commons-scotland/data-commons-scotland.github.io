...
var i_39570 = (0);
while(true){
if((i_39570 < arr.length)){
(arr[i_39570] = null);

var G__39571 = (i_39570 + (1));
i_39570 = G__39571;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_39678 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_39678[i]));
} else {
x__$2.forward.push((((i < links_39678.length))?(links_39678[i]):null));
}

if((i < links_39678.length)){
(links_39678[i] = x__$2);
} else {
links_39678.push(x__$2);
}
...
var i_39681 = (0);
while(true){
if((i_39681 <= self__.level)){
var links_39682 = (update[i_39681]).forward;
if((x__$1 === (((i_39681 < links_39682.length))?(links_39682[i_39681]):null))){
(links_39682[i_39681] = (x__$1.forward[i_39681]));

var G__39683 = (i_39681 + (1));
i_39681 = G__39683;
continue;
} else {
var G__39684 = (i_39681 + (1));
i_39681 = G__39684;
continue;
}
} else {
