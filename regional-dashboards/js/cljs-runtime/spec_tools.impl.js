...
var vec__27974 = cljs.core.rest(expr);
...
var vec__27977 = first__27976;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27977,(0),null);
var form = seq__27975__$1;
...
var G__27980 = x;
var G__27980__$1 = (((G__27980 == null))?null:spec_tools.impl.polish(G__27980));
var G__27980__$2 = (((G__27980__$1 == null))?null:cljs.core.name(G__27980__$1));
if((G__27980__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__27980__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__27981 = x;
var G__27981__$1 = (((G__27981 == null))?null:cljs.core.name(G__27981));
if((G__27981__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__27981__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__27982){
...
var data = map__27983__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27983__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27983__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27983__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27983__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__27985){
var map__27986 = p__27985;
var map__27986__$1 = (((((!((map__27986 == null))))?(((((map__27986.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27986.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27986):map__27986);
var data = map__27986__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27986__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27986__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__27988 = data;
var G__27988__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27988,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__27988);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27988__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__27988__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__27992 = form;
var G__27992__$1 = (((G__27992 == null))?null:cljs.core.rest(G__27992));
if((G__27992__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__27992__$1);
}
})();
var G__27993 = m;
var G__27993__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27993,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__27989_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__27989_SHARP_)));
})):G__27993);
var G__27993__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27993__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__27990_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__27990_SHARP_)));
})):G__27993__$1);
var G__27993__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__27993__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__27991_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__27991_SHARP_));
})):G__27993__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__27993__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__27994 = (function (){var G__27995 = form;
var G__27995__$1 = (((G__27995 == null))?null:cljs.core.rest(G__27995));
if((G__27995__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__27995__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27994__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27994__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27994__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27994__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__27997 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__27997) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__27998 = form;
var G__27998__$1 = (((G__27998 == null))?null:cljs.core.seq(G__27998));
var G__27998__$2 = (((G__27998__$1 == null))?null:cljs.core.first(G__27998__$1));
if((G__27998__$2 == null)){
return null;
} else {
var fexpr__27999 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__27999.cljs$core$IFn$_invoke$arity$1 ? fexpr__27999.cljs$core$IFn$_invoke$arity$1(G__27998__$2) : fexpr__27999.call(null,G__27998__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq28000){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__28001){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__28007){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28008__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28008__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28008__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28008__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__28005_SHARP_){
return cljs.core.map_QMARK_(p1__28005_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__28006_SHARP_){
return cljs.core.contains_QMARK_(p1__28006_SHARP_,x);
});
}),req_keys));
