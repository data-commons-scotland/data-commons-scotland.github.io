...
var token=parseExpression();expect(")");return token}if(match("[")){token=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),token.push(null)):(token.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_3474=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_3474.elements=token;return JSCompiler_object_inline_value_3474}if(match("{")){token=[];JSCompiler_object_inline_value_3474={};var JSCompiler_object_inline_literal_3475=
String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_3476=lookahead;if(3===JSCompiler_object_inline_value_3476.type){var JSCompiler_object_inline_literal_3477=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_3476=parseConditionalExpression();JSCompiler_object_inline_value_3476=finishProperty("init",JSCompiler_object_inline_literal_3477,JSCompiler_object_inline_value_3476)}else 2===JSCompiler_object_inline_value_3476.type||
7===JSCompiler_object_inline_value_3476.type?(throwUnexpected(JSCompiler_object_inline_value_3476),JSCompiler_object_inline_value_3476=void 0):(JSCompiler_object_inline_literal_3477=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_3476=parseConditionalExpression(),JSCompiler_object_inline_value_3476=finishProperty("init",JSCompiler_object_inline_literal_3477,JSCompiler_object_inline_value_3476));JSCompiler_object_inline_literal_3477="Identifier"===JSCompiler_object_inline_value_3476.key.type?
JSCompiler_object_inline_value_3476.key.name:JSCompiler_object_inline_literal_3475(JSCompiler_object_inline_value_3476.key.value);JSCompiler_object_inline_literal_3477="$"+JSCompiler_object_inline_literal_3477;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_3474,JSCompiler_object_inline_literal_3477)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_3474[JSCompiler_object_inline_literal_3477]=!0;token.push(JSCompiler_object_inline_value_3476);
match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_3474=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_3474.properties=token;return JSCompiler_object_inline_value_3474}JSCompiler_object_inline_value_3474=lookahead.type;index$jscomp$0=lookahead.start;if(3===JSCompiler_object_inline_value_3474||legalKeywords[lookahead.value])token=finishIdentifier(lex().value);else if(8===JSCompiler_object_inline_value_3474||6===JSCompiler_object_inline_value_3474)lookahead.octal&&throwError(lookahead,
"Octal literals are not allowed in strict mode."),token=finishLiteral(lex());else{if(4===JSCompiler_object_inline_value_3474)throw Error("Disabled.");if(1===JSCompiler_object_inline_value_3474)token=lex(),token.value="true"===token.value,token=finishLiteral(token);else if(5===JSCompiler_object_inline_value_3474)token=lex(),token.value=null,token=finishLiteral(token);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();token=index$jscomp$0;JSCompiler_object_inline_value_3474=
source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_3474,"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_3475=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_3477=JSCompiler_object_inline_value_3476=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_3474=source[index$jscomp$0++],JSCompiler_object_inline_literal_3475+=JSCompiler_object_inline_value_3474,"\\"===JSCompiler_object_inline_value_3474)JSCompiler_object_inline_value_3474=
source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_3474.charCodeAt(0))&&throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_3475+=JSCompiler_object_inline_value_3474;else if(isLineTerminator(JSCompiler_object_inline_value_3474.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_3476)"]"===JSCompiler_object_inline_value_3474&&(JSCompiler_object_inline_value_3476=!1);else if("/"===JSCompiler_object_inline_value_3474){JSCompiler_object_inline_literal_3477=
!0;break}else"["===JSCompiler_object_inline_value_3474&&(JSCompiler_object_inline_value_3476=!0);JSCompiler_object_inline_literal_3477||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_3474=JSCompiler_object_inline_literal_3475.substr(1,JSCompiler_object_inline_literal_3475.length-2);for(value=JSCompiler_object_inline_literal_3477="";index$jscomp$0<length;){JSCompiler_object_inline_value_3476=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_3476.charCodeAt(0)))break;
++index$jscomp$0;"\\"===JSCompiler_object_inline_value_3476&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_3476,JSCompiler_object_inline_literal_3477+=JSCompiler_object_inline_value_3476)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_3476=value;value=testRegExp(JSCompiler_object_inline_value_3474,JSCompiler_object_inline_value_3476);token=finishLiteral({literal:JSCompiler_object_inline_literal_3475+
JSCompiler_object_inline_literal_3477,value:value,regex:{pattern:JSCompiler_object_inline_value_3474,flags:JSCompiler_object_inline_value_3476},start:token,end:index$jscomp$0});JSCompiler_object_inline_value_3474=index$jscomp$0;lookahead=advance();index$jscomp$0=JSCompiler_object_inline_value_3474}else throwUnexpected(lex())}return token}function parsePostfixExpression(){var JSCompiler_inline_result;for(JSCompiler_inline_result=parsePrimaryExpression();;)if(match(".")){expect(".");index$jscomp$0=
