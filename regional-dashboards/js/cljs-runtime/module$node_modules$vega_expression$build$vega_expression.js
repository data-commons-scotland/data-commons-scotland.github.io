...
var token=parseExpression();expect(")");return token}if(match("[")){token=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),token.push(null)):(token.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_5326=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_5326.elements=token;return JSCompiler_object_inline_value_5326}if(match("{")){token=[];JSCompiler_object_inline_value_5326={};var JSCompiler_object_inline_literal_5327=
String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_5328=lookahead;if(3===JSCompiler_object_inline_value_5328.type){var JSCompiler_object_inline_literal_5329=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_5328=parseConditionalExpression();JSCompiler_object_inline_value_5328=finishProperty("init",JSCompiler_object_inline_literal_5329,JSCompiler_object_inline_value_5328)}else 2===JSCompiler_object_inline_value_5328.type||
7===JSCompiler_object_inline_value_5328.type?(throwUnexpected(JSCompiler_object_inline_value_5328),JSCompiler_object_inline_value_5328=void 0):(JSCompiler_object_inline_literal_5329=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_5328=parseConditionalExpression(),JSCompiler_object_inline_value_5328=finishProperty("init",JSCompiler_object_inline_literal_5329,JSCompiler_object_inline_value_5328));JSCompiler_object_inline_literal_5329="Identifier"===JSCompiler_object_inline_value_5328.key.type?
JSCompiler_object_inline_value_5328.key.name:JSCompiler_object_inline_literal_5327(JSCompiler_object_inline_value_5328.key.value);JSCompiler_object_inline_literal_5329="$"+JSCompiler_object_inline_literal_5329;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_5326,JSCompiler_object_inline_literal_5329)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_5326[JSCompiler_object_inline_literal_5329]=!0;token.push(JSCompiler_object_inline_value_5328);
match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_5326=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_5326.properties=token;return JSCompiler_object_inline_value_5326}JSCompiler_object_inline_value_5326=lookahead.type;index$jscomp$0=lookahead.start;if(3===JSCompiler_object_inline_value_5326||legalKeywords[lookahead.value])token=finishIdentifier(lex().value);else if(8===JSCompiler_object_inline_value_5326||6===JSCompiler_object_inline_value_5326)lookahead.octal&&throwError(lookahead,
"Octal literals are not allowed in strict mode."),token=finishLiteral(lex());else{if(4===JSCompiler_object_inline_value_5326)throw Error("Disabled.");if(1===JSCompiler_object_inline_value_5326)token=lex(),token.value="true"===token.value,token=finishLiteral(token);else if(5===JSCompiler_object_inline_value_5326)token=lex(),token.value=null,token=finishLiteral(token);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();token=index$jscomp$0;JSCompiler_object_inline_value_5326=
source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_5326,"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_5327=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_5329=JSCompiler_object_inline_value_5328=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_5326=source[index$jscomp$0++],JSCompiler_object_inline_literal_5327+=JSCompiler_object_inline_value_5326,"\\"===JSCompiler_object_inline_value_5326)JSCompiler_object_inline_value_5326=
source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_5326.charCodeAt(0))&&throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_5327+=JSCompiler_object_inline_value_5326;else if(isLineTerminator(JSCompiler_object_inline_value_5326.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_5328)"]"===JSCompiler_object_inline_value_5326&&(JSCompiler_object_inline_value_5328=!1);else if("/"===JSCompiler_object_inline_value_5326){JSCompiler_object_inline_literal_5329=
!0;break}else"["===JSCompiler_object_inline_value_5326&&(JSCompiler_object_inline_value_5328=!0);JSCompiler_object_inline_literal_5329||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_5326=JSCompiler_object_inline_literal_5327.substr(1,JSCompiler_object_inline_literal_5327.length-2);for(value=JSCompiler_object_inline_literal_5329="";index$jscomp$0<length;){JSCompiler_object_inline_value_5328=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_5328.charCodeAt(0)))break;
++index$jscomp$0;"\\"===JSCompiler_object_inline_value_5328&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_5328,JSCompiler_object_inline_literal_5329+=JSCompiler_object_inline_value_5328)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_5328=value;value=testRegExp(JSCompiler_object_inline_value_5326,JSCompiler_object_inline_value_5328);token=finishLiteral({literal:JSCompiler_object_inline_literal_5327+
JSCompiler_object_inline_literal_5329,value:value,regex:{pattern:JSCompiler_object_inline_value_5326,flags:JSCompiler_object_inline_value_5328},start:token,end:index$jscomp$0});JSCompiler_object_inline_value_5326=index$jscomp$0;lookahead=advance();index$jscomp$0=JSCompiler_object_inline_value_5326}else throwUnexpected(lex())}return token}function parsePostfixExpression(){var JSCompiler_inline_result;for(JSCompiler_inline_result=parsePrimaryExpression();;)if(match(".")){expect(".");index$jscomp$0=
...
opt||{};var allowed=opt.allowed?vegaUtil.toSet(opt.allowed):{},forbidden=opt.forbidden?vegaUtil.toSet(opt.forbidden):{},constants=opt.constants||Constants,functions=(opt.functions||Functions)(visit),globalvar=opt.globalvar,fieldvar=opt.fieldvar,outputGlobal=vegaUtil.isFunction(globalvar)?globalvar:function(id){return globalvar+'["'+id+'"]'},globals={},fields={},memberDepth=0,Generators={Literal:function(n){return n.raw},Identifier:function(n){n=n.name;if(0<memberDepth)return n;if(vegaUtil.hasOwnProperty(forbidden,
