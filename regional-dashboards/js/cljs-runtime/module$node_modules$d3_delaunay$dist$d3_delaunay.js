...
1]=getY(p)}return new Delaunator(coords)};Delaunator.prototype.update=function(){for(var JSCompiler_object_inline_x_2920,JSCompiler_object_inline_y_2921,coords=this.coords,hullPrev=this._hullPrev,hullNext=this._hullNext,hullTri=this._hullTri,hullHash=this._hullHash,n=coords.length>>1,minX=Infinity,minY=Infinity,maxX=-Infinity,maxY=-Infinity,i=0;i<n;i++){var x=coords[2*i];JSCompiler_object_inline_x_2920=coords[2*i+1];x<minX&&(minX=x);JSCompiler_object_inline_x_2920<minY&&(minY=JSCompiler_object_inline_x_2920);
x>maxX&&(maxX=x);JSCompiler_object_inline_x_2920>maxY&&(maxY=JSCompiler_object_inline_x_2920);this._ids[i]=i}maxX=(minX+maxX)/2;minY=(minY+maxY)/2;minX=Infinity;for(maxY=0;maxY<n;maxY++)if(i=dist(maxX,minY,coords[2*maxY],coords[2*maxY+1]),i<minX){var i0=maxY;minX=i}minY=coords[2*i0];maxY=coords[2*i0+1];minX=Infinity;for(maxX=0;maxX<n;maxX++)if(maxX!==i0&&(i=dist(minY,maxY,coords[2*maxX],coords[2*maxX+1]),i<minX&&0<i)){var i1=maxX;minX=i}minX=coords[2*i1];maxX=coords[2*i1+1];JSCompiler_object_inline_x_2920=
Infinity;for(i=0;i<n;i++)if(i!==i0&&i!==i1){x=minX-minY;var dy=maxX-maxY;JSCompiler_object_inline_y_2921=coords[2*i]-minY;var ey=coords[2*i+1]-maxY,bl=x*x+dy*dy,cl=JSCompiler_object_inline_y_2921*JSCompiler_object_inline_y_2921+ey*ey,d=.5/(x*ey-dy*JSCompiler_object_inline_y_2921);dy=(ey*bl-dy*cl)*d;x=(x*cl-JSCompiler_object_inline_y_2921*bl)*d;x=dy*dy+x*x;if(x<JSCompiler_object_inline_x_2920){var i2=i;JSCompiler_object_inline_x_2920=x}}i=coords[2*i2];x=coords[2*i2+1];if(Infinity===JSCompiler_object_inline_x_2920){for(hullNext=
0;hullNext<n;hullNext++)this._dists[hullNext]=coords[2*hullNext]-coords[0]||coords[2*hullNext+1]-coords[1];quicksort(this._ids,this._dists,0,n-1);hullNext=new Uint32Array(n);hullPrev=coords=0;for(hullTri=-Infinity;hullPrev<n;hullPrev++)hullHash=this._ids[hullPrev],this._dists[hullHash]>hullTri&&(hullNext[coords++]=hullHash,hullTri=this._dists[hullHash]);this.hull=hullNext.subarray(0,coords);this.triangles=new Uint32Array(0);this.halfedges=new Uint32Array(0)}else{orient(minY,maxY,minX,maxX,i,x)&&(JSCompiler_object_inline_x_2920=
i1,JSCompiler_object_inline_y_2921=minX,bl=maxX,i1=i2,minX=i,maxX=x,i2=JSCompiler_object_inline_x_2920,i=JSCompiler_object_inline_y_2921,x=bl);JSCompiler_object_inline_y_2921=minX-minY;JSCompiler_object_inline_x_2920=maxX-maxY;bl=i-minY;ey=x-maxY;cl=JSCompiler_object_inline_y_2921*JSCompiler_object_inline_y_2921+JSCompiler_object_inline_x_2920*JSCompiler_object_inline_x_2920;d=bl*bl+ey*ey;dy=.5/(JSCompiler_object_inline_y_2921*ey-JSCompiler_object_inline_x_2920*bl);JSCompiler_object_inline_x_2920=
minY+(ey*cl-JSCompiler_object_inline_x_2920*d)*dy;JSCompiler_object_inline_y_2921=maxY+(JSCompiler_object_inline_y_2921*d-bl*cl)*dy;this._cx=JSCompiler_object_inline_x_2920;this._cy=JSCompiler_object_inline_y_2921;for(bl=0;bl<n;bl++)this._dists[bl]=dist(coords[2*bl],coords[2*bl+1],JSCompiler_object_inline_x_2920,JSCompiler_object_inline_y_2921);quicksort(this._ids,this._dists,0,n-1);this._hullStart=i0;n=3;hullNext[i0]=hullPrev[i2]=i1;hullNext[i1]=hullPrev[i0]=i2;hullNext[i2]=hullPrev[i1]=i0;hullTri[i0]=
0;hullTri[i1]=1;hullTri[i2]=2;hullHash.fill(-1);hullHash[this._hashKey(minY,maxY)]=i0;hullHash[this._hashKey(minX,maxX)]=i1;hullHash[this._hashKey(i,x)]=i2;this.trianglesLen=0;this._addTriangle(i0,i1,i2,-1,-1,-1);minY=0;for(minX=maxY=void 0;minY<this._ids.length;minY++)if(maxX=this._ids[minY],i=coords[2*maxX],x=coords[2*maxX+1],!(0<minY&&Math.abs(i-maxY)<=EPSILON&&Math.abs(x-minX)<=EPSILON)&&(maxY=i,minX=x,maxX!==i0&&maxX!==i1&&maxX!==i2)){JSCompiler_object_inline_y_2921=JSCompiler_object_inline_x_2920=
0;for(bl=this._hashKey(i,x);JSCompiler_object_inline_y_2921<this._hashSize&&(JSCompiler_object_inline_x_2920=hullHash[(bl+JSCompiler_object_inline_y_2921)%this._hashSize],-1===JSCompiler_object_inline_x_2920||JSCompiler_object_inline_x_2920===hullNext[JSCompiler_object_inline_x_2920]);JSCompiler_object_inline_y_2921++);JSCompiler_object_inline_y_2921=JSCompiler_object_inline_x_2920=hullPrev[JSCompiler_object_inline_x_2920];for(bl=void 0;bl=hullNext[JSCompiler_object_inline_y_2921],!orient(i,x,coords[2*
JSCompiler_object_inline_y_2921],coords[2*JSCompiler_object_inline_y_2921+1],coords[2*bl],coords[2*bl+1]);)if(JSCompiler_object_inline_y_2921=bl,JSCompiler_object_inline_y_2921===JSCompiler_object_inline_x_2920){JSCompiler_object_inline_y_2921=-1;break}if(-1!==JSCompiler_object_inline_y_2921){cl=this._addTriangle(JSCompiler_object_inline_y_2921,maxX,hullNext[JSCompiler_object_inline_y_2921],-1,-1,hullTri[JSCompiler_object_inline_y_2921]);hullTri[maxX]=this._legalize(cl+2);hullTri[JSCompiler_object_inline_y_2921]=
cl;n++;for(d=hullNext[JSCompiler_object_inline_y_2921];bl=hullNext[d],orient(i,x,coords[2*d],coords[2*d+1],coords[2*bl],coords[2*bl+1]);)cl=this._addTriangle(d,maxX,bl,hullTri[maxX],-1,hullTri[d]),hullTri[maxX]=this._legalize(cl+2),hullNext[d]=d,n--,d=bl;if(JSCompiler_object_inline_y_2921===JSCompiler_object_inline_x_2920)for(;bl=hullPrev[JSCompiler_object_inline_y_2921],orient(i,x,coords[2*bl],coords[2*bl+1],coords[2*JSCompiler_object_inline_y_2921],coords[2*JSCompiler_object_inline_y_2921+1]);)cl=
this._addTriangle(bl,maxX,JSCompiler_object_inline_y_2921,-1,hullTri[JSCompiler_object_inline_y_2921],hullTri[bl]),this._legalize(cl+2),hullTri[bl]=cl,hullNext[JSCompiler_object_inline_y_2921]=JSCompiler_object_inline_y_2921,n--,JSCompiler_object_inline_y_2921=bl;this._hullStart=hullPrev[maxX]=JSCompiler_object_inline_y_2921;hullNext[JSCompiler_object_inline_y_2921]=hullPrev[d]=maxX;hullNext[maxX]=d;hullHash[this._hashKey(i,x)]=maxX;hullHash[this._hashKey(coords[2*JSCompiler_object_inline_y_2921],
coords[2*JSCompiler_object_inline_y_2921+1])]=JSCompiler_object_inline_y_2921}}this.hull=new Uint32Array(n);coords=0;for(hullPrev=this._hullStart;coords<n;coords++)this.hull[coords]=hullPrev,hullPrev=hullNext[hullPrev];this.triangles=this._triangles.subarray(0,this.trianglesLen);this.halfedges=this._halfedges.subarray(0,this.trianglesLen)}};Delaunator.prototype._hashKey=function(x,y){return Math.floor(pseudoAngle(x-this._cx,y-this._cy)*this._hashSize)%this._hashSize};Delaunator.prototype._legalize=
...
this._y1=+y)+"h"+ +w+"v"+ +h+"h"+-w+"Z"};Path.prototype.value=function(){return this._||null};var Polygon=function(){this._=[]};Polygon.prototype.moveTo=function(x,y){this._.push([x,y])};Polygon.prototype.closePath=function(){this._.push(this._[0].slice())};Polygon.prototype.lineTo=function(x,y){this._.push([x,y])};Polygon.prototype.value=function(){return this._.length?this._:null};var Voronoi=function(delaunay,$jscomp$destructuring$var59){var $jscomp$destructuring$var60=$jscomp.makeIterator(void 0===
$jscomp$destructuring$var59?[0,0,960,500]:$jscomp$destructuring$var59);$jscomp$destructuring$var59=$jscomp$destructuring$var60.next().value;var ymin=$jscomp$destructuring$var60.next().value,xmax=$jscomp$destructuring$var60.next().value;$jscomp$destructuring$var60=$jscomp$destructuring$var60.next().value;if(!((xmax=+xmax)>=($jscomp$destructuring$var59=+$jscomp$destructuring$var59)&&($jscomp$destructuring$var60=+$jscomp$destructuring$var60)>=(ymin=+ymin)))throw Error("invalid bounds");this.delaunay=
delaunay;this._circumcenters=new Float64Array(2*delaunay.points.length);this.vectors=new Float64Array(2*delaunay.points.length);this.xmax=xmax;this.xmin=$jscomp$destructuring$var59;this.ymax=$jscomp$destructuring$var60;this.ymin=ymin;this._init()};Voronoi.prototype.update=function(){this.delaunay.update();this._init();return this};Voronoi.prototype._init=function(){var $jscomp$destructuring$var62=this.delaunay,points=$jscomp$destructuring$var62.points,hull=$jscomp$destructuring$var62.hull,triangles=
$jscomp$destructuring$var62.triangles;$jscomp$destructuring$var62=this.vectors;for(var circumcenters=this.circumcenters=this._circumcenters.subarray(0,triangles.length/3*2),i=0,j=0,n=triangles.length,x,y;i<n;i+=3,j+=2){y=2*triangles[i];var t2=2*triangles[i+1],t3=2*triangles[i+2];x=points[y];y=points[y+1];var x3=points[t3],y3=points[t3+1];t3=points[t2]-x;var dy=points[t2+1]-y;t2=x3-x;var ey=y3-y,bl=t3*t3+dy*dy,cl=t2*t2+ey*ey,ab=2*(t3*ey-dy*t2);ab?1E-8>Math.abs(ab)?(x=(x+x3)/2,y=(y+y3)/2):(x3=1/ab,
x+=(ey*bl-dy*cl)*x3,y+=(t3*cl-t2*bl)*x3):(x=(x+x3)/2-1E8*ey,y=(y+y3)/2+1E8*t2);circumcenters[j]=x;circumcenters[j+1]=y}triangles=hull[hull.length-1];i=4*triangles;n=points[2*triangles];y=points[2*triangles+1];$jscomp$destructuring$var62.fill(0);for(t3=0;t3<hull.length;++t3)triangles=hull[t3],circumcenters=i,j=n,x=y,i=4*triangles,n=points[2*triangles],y=points[2*triangles+1],$jscomp$destructuring$var62[circumcenters+2]=$jscomp$destructuring$var62[i]=x-y,$jscomp$destructuring$var62[circumcenters+3]=
$jscomp$destructuring$var62[i+1]=n-j};Voronoi.prototype.render=function(context){var buffer=null==context?context=new Path:void 0,$jscomp$destructuring$var64=this.delaunay,halfedges=$jscomp$destructuring$var64.halfedges,inedges=$jscomp$destructuring$var64.inedges;$jscomp$destructuring$var64=$jscomp$destructuring$var64.hull;var circumcenters=this.circumcenters,vectors=this.vectors;if(1>=$jscomp$destructuring$var64.length)return null;for(var i=0,n=halfedges.length;i<n;++i){var j=halfedges[i];if(!(j<
i)){var ti=2*Math.floor(i/3);j=2*Math.floor(j/3);this._renderSegment(circumcenters[ti],circumcenters[ti+1],circumcenters[j],circumcenters[j+1],context)}}halfedges=$jscomp$destructuring$var64[$jscomp$destructuring$var64.length-1];for(i=0;i<$jscomp$destructuring$var64.length;++i)j=halfedges,halfedges=$jscomp$destructuring$var64[i],ti=2*Math.floor(inedges[halfedges]/3),n=circumcenters[ti],ti=circumcenters[ti+1],j*=4,(j=this._project(n,ti,vectors[j+2],vectors[j+3]))&&this._renderSegment(n,ti,j[0],j[1],
context);return buffer&&buffer.value()};Voronoi.prototype.renderBounds=function(context){var buffer=null==context?context=new Path:void 0;context.rect(this.xmin,this.ymin,this.xmax-this.xmin,this.ymax-this.ymin);return buffer&&buffer.value()};Voronoi.prototype.renderCell=function(i,context){var buffer=null==context?context=new Path:void 0;i=this._clip(i);if(null!==i&&i.length){context.moveTo(i[0],i[1]);for(var n=i.length;i[0]===i[n-2]&&i[1]===i[n-1]&&1<n;)n-=2;for(var i$504=2;i$504<n;i$504+=2)i[i$504]===
i[i$504-2]&&i[i$504+1]===i[i$504-1]||context.lineTo(i[i$504],i[i$504+1]);context.closePath();return buffer&&buffer.value()}};Voronoi.prototype.cellPolygons=function $jscomp$generator$function(){var $jscomp$generator$this=this,$jscomp$destructuring$var65,$jscomp$destructuring$var66,points,i,n,cell;return $jscomp.generator.createGenerator($jscomp$generator$function,function($jscomp$generator$context){switch($jscomp$generator$context.nextAddress){case 1:$jscomp$destructuring$var65=$jscomp$generator$this,
$jscomp$destructuring$var66=$jscomp$destructuring$var65.delaunay,points=$jscomp$destructuring$var66.points,i=0,n=points.length/2;case 2:if(!(i<n)){$jscomp$generator$context.jumpTo(0);break}cell=$jscomp$generator$this.cellPolygon(i);if(!cell){$jscomp$generator$context.jumpTo(3);break}cell.index=i;return $jscomp$generator$context.yield(cell,6);case 6:case 3:++i,$jscomp$generator$context.jumpTo(2)}})};Voronoi.prototype.cellPolygon=function(i){var polygon=new Polygon;this.renderCell(i,polygon);return polygon.value()};
...
2;$jscomp$generator$context.jumpTo(10);break;case 4:$jscomp$key$j=$jscomp$iter$118.next(),$jscomp$generator$context.jumpTo(3)}})};Voronoi.prototype._cell=function(i){var circumcenters=this.circumcenters,$jscomp$destructuring$var68=this.delaunay,halfedges=$jscomp$destructuring$var68.halfedges,triangles=$jscomp$destructuring$var68.triangles;$jscomp$destructuring$var68=$jscomp$destructuring$var68.inedges[i];if(-1===$jscomp$destructuring$var68)return null;var points=[],e=$jscomp$destructuring$var68;do{var t=
Math.floor(e/3);points.push(circumcenters[2*t],circumcenters[2*t+1]);e=2===e%3?e-2:e+1;if(triangles[e]!==i)break;e=halfedges[e]}while(e!==$jscomp$destructuring$var68&&-1!==e);return points};Voronoi.prototype._clip=function(i){if(0===i&&1===this.delaunay.hull.length)return[this.xmax,this.ymin,this.xmax,this.ymax,this.xmin,this.ymax,this.xmin,this.ymin];var points=this._cell(i);if(null===points)return null;var V=this.vectors,v=4*i;return V[v]||V[v+1]?this._clipInfinite(i,points,V[v],V[v+1],V[v+2],V[v+
...
points[2*d+1],points[2*f],points[2*f+1]];d=1E-8*Math.hypot(d[3]-d[1],d[2]-d[0]);f=0;for(var n=points.length/2;f<n;++f){var p=jitter(points[2*f],points[2*f+1],d);points[2*f]=p[0];points[2*f+1]=p[1]}this._delaunator=new Delaunator(points)}else delete this.collinear;p=this.halfedges=this._delaunator.halfedges;d=this.hull=this._delaunator.hull;var triangles=this.triangles=this._delaunator.triangles;f=this.inedges.fill(-1);n=this._hullIndex.fill(-1);for(var e$507=0,n$508=p.length;e$507<n$508;++e$507){var p$509=
triangles[2===e$507%3?e$507-2:e$507+1];if(-1===p[e$507]||-1===f[p$509])f[p$509]=e$507}p=0;for(triangles=d.length;p<triangles;++p)n[d[p]]=p;2>=d.length&&0<d.length&&(this.triangles=(new Int32Array(3)).fill(-1),this.halfedges=(new Int32Array(3)).fill(-1),this.triangles[0]=d[0],this.triangles[1]=d[1],this.triangles[2]=d[1],f[d[0]]=1,2===d.length&&(f[d[1]]=0))};Delaunay.prototype.voronoi=function(bounds){return new Voronoi(this,bounds)};Delaunay.prototype.neighbors=function $jscomp$generator$function(i){var $jscomp$generator$this=
this,$jscomp$destructuring$var73,inedges,hull,_hullIndex,halfedges,triangles,collinear,l,e0,e,p0,p;return $jscomp.generator.createGenerator($jscomp$generator$function,function($jscomp$generator$context){switch($jscomp$generator$context.nextAddress){case 1:$jscomp$destructuring$var73=$jscomp$generator$this;inedges=$jscomp$destructuring$var73.inedges;hull=$jscomp$destructuring$var73.hull;_hullIndex=$jscomp$destructuring$var73._hullIndex;halfedges=$jscomp$destructuring$var73.halfedges;triangles=$jscomp$destructuring$var73.triangles;
collinear=$jscomp$destructuring$var73.collinear;if(!collinear){$jscomp$generator$context.jumpTo(2);break}l=collinear.indexOf(i);if(!(0<l)){$jscomp$generator$context.jumpTo(3);break}return $jscomp$generator$context.yield(collinear[l-1],3);case 3:if(!(l<collinear.length-1)){$jscomp$generator$context.jumpTo(5);break}return $jscomp$generator$context.yield(collinear[l+1],5);case 5:return $jscomp$generator$context.return();case 2:e0=inedges[i];if(-1===e0)return $jscomp$generator$context.return();e=e0;p0=
...
null==context?context=new Path:void 0,hull=this.hull,points=this.points,h=2*hull[0],n=hull.length;context.moveTo(points[h],points[h+1]);for(h=1;h<n;++h){var h$512=2*hull[h];context.lineTo(points[h$512],points[h$512+1])}context.closePath();return buffer&&buffer.value()};Delaunay.prototype.hullPolygon=function(){var polygon=new Polygon;this.renderHull(polygon);return polygon.value()};Delaunay.prototype.renderTriangle=function(i,context){var buffer=null==context?context=new Path:void 0,points=this.points,
triangles=this.triangles,t0=2*triangles[i*=3],t1=2*triangles[i+1];i=2*triangles[i+2];context.moveTo(points[t0],points[t0+1]);context.lineTo(points[t1],points[t1+1]);context.lineTo(points[i],points[i+1]);context.closePath();return buffer&&buffer.value()};Delaunay.prototype.trianglePolygons=function $jscomp$generator$function(){var $jscomp$generator$this=this,$jscomp$destructuring$var79,triangles,i,n;return $jscomp.generator.createGenerator($jscomp$generator$function,function($jscomp$generator$context){1==
$jscomp$generator$context.nextAddress&&($jscomp$destructuring$var79=$jscomp$generator$this,triangles=$jscomp$destructuring$var79.triangles,i=0,n=triangles.length/3);if(3!=$jscomp$generator$context.nextAddress)return i<n?$jscomp$generator$context.yield($jscomp$generator$this.trianglePolygon(i),3):$jscomp$generator$context.jumpTo(0);++i;return $jscomp$generator$context.jumpTo(2)})};Delaunay.prototype.trianglePolygon=function(i){var polygon=new Polygon;this.renderTriangle(i,polygon);return polygon.value()};
