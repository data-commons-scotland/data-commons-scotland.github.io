...
if((x instanceof cljs.core.Keyword)){
var G__28068 = spec;
var G__28069 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__28070 = spec;
var G__28071 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28070,G__28071) : f.call(null,G__28070,G__28071));
} else {
return x;
...
if(typeof x === 'number'){
var G__28072 = spec;
var G__28073 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28072,G__28073) : f.call(null,G__28072,G__28073));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e28075){if((e28075 instanceof Error)){
var ___$1 = e28075;
return x;
} else {
throw e28075;
...
}catch (e28077){if((e28077 instanceof Error)){
var ___$1 = e28077;
return x;
} else {
throw e28077;
...
}catch (e28079){if((e28079 instanceof Error)){
var ___$1 = e28079;
return x;
} else {
throw e28079;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__28080,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28081__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__28083,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28084__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__28086,x){
var map__28087 = p__28086;
var map__28087__$1 = (((((!((map__28087 == null))))?(((((map__28087.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28087.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28087):map__28087);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28087__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
