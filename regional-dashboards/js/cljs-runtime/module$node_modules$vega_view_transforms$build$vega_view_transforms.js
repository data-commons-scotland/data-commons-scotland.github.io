...
vegaDataflow.Transform,{transform:function(_,pulse){var view=pulse.dataflow;_.mark.items.forEach(function(group){if(_.layout){for(var opt=_.layout,groups=group.items,n=groups.length,i=0,mark,items,JSCompiler_object_inline_marks_3552=[],JSCompiler_object_inline_rowheaders_3553=[],JSCompiler_object_inline_rowfooters_3554=[],JSCompiler_object_inline_colheaders_3555=[],JSCompiler_object_inline_colfooters_3556=[],JSCompiler_object_inline_rowtitle_3557=null,JSCompiler_object_inline_coltitle_3558=null;i<
n;++i)if(mark=groups[i],items=mark.items,"group"===mark.marktype)switch(mark.role){case "axis":case "legend":case "title":break;case "row-header":JSCompiler_object_inline_rowheaders_3553.push.apply(JSCompiler_object_inline_rowheaders_3553,$jscomp.arrayFromIterable(items));break;case "row-footer":JSCompiler_object_inline_rowfooters_3554.push.apply(JSCompiler_object_inline_rowfooters_3554,$jscomp.arrayFromIterable(items));break;case "column-header":JSCompiler_object_inline_colheaders_3555.push.apply(JSCompiler_object_inline_colheaders_3555,
$jscomp.arrayFromIterable(items));break;case "column-footer":JSCompiler_object_inline_colfooters_3556.push.apply(JSCompiler_object_inline_colfooters_3556,$jscomp.arrayFromIterable(items));break;case "row-title":JSCompiler_object_inline_rowtitle_3557=items[0];break;case "column-title":JSCompiler_object_inline_coltitle_3558=items[0];break;default:JSCompiler_object_inline_marks_3552.push.apply(JSCompiler_object_inline_marks_3552,$jscomp.arrayFromIterable(items))}mark="flush"===opt.bounds?boundFlush:
boundFull;groups=opt.offset;items=opt.columns||JSCompiler_object_inline_marks_3552.length;var nrows=0>=items?1:Math.ceil(JSCompiler_object_inline_marks_3552.length/items),cells=nrows*items;n=gridLayout(view,JSCompiler_object_inline_marks_3552,opt);n.empty()&&n.set(0,0,0,0);if(JSCompiler_object_inline_rowheaders_3553){i=get(opt.headerBand,"row",null);var x=layoutHeaders(view,JSCompiler_object_inline_rowheaders_3553,JSCompiler_object_inline_marks_3552,items,nrows,-get(groups,"rowHeader"),min,0,mark,
"x1",0,items,1,i)}if(JSCompiler_object_inline_colheaders_3555){i=get(opt.headerBand,"column",null);var y=layoutHeaders(view,JSCompiler_object_inline_colheaders_3555,JSCompiler_object_inline_marks_3552,items,items,-get(groups,"columnHeader"),min,1,mark,"y1",0,1,items,i)}if(JSCompiler_object_inline_rowfooters_3554){i=get(opt.footerBand,"row",null);var x2=layoutHeaders(view,JSCompiler_object_inline_rowfooters_3554,JSCompiler_object_inline_marks_3552,items,nrows,get(groups,"rowFooter"),max$jscomp$0,0,
mark,"x2",items-1,items,1,i)}if(JSCompiler_object_inline_colfooters_3556){i=get(opt.footerBand,"column",null);var y2=layoutHeaders(view,JSCompiler_object_inline_colfooters_3556,JSCompiler_object_inline_marks_3552,items,items,get(groups,"columnFooter"),max$jscomp$0,1,mark,"y2",cells-items,1,items,i)}JSCompiler_object_inline_rowtitle_3557&&(JSCompiler_object_inline_rowheaders_3553=get(opt.titleAnchor,"row"),JSCompiler_object_inline_marks_3552=get(groups,"rowTitle"),JSCompiler_object_inline_marks_3552=
"end"===JSCompiler_object_inline_rowheaders_3553?x2+JSCompiler_object_inline_marks_3552:x-JSCompiler_object_inline_marks_3552,i=get(opt.titleBand,"row",.5),layoutTitle(view,JSCompiler_object_inline_rowtitle_3557,JSCompiler_object_inline_marks_3552,0,n,i));JSCompiler_object_inline_coltitle_3558&&(JSCompiler_object_inline_rowheaders_3553=get(opt.titleAnchor,"column"),JSCompiler_object_inline_marks_3552=get(groups,"columnTitle"),JSCompiler_object_inline_marks_3552="end"===JSCompiler_object_inline_rowheaders_3553?
y2+JSCompiler_object_inline_marks_3552:y-JSCompiler_object_inline_marks_3552,i=get(opt.titleBand,"column",.5),layoutTitle(view,JSCompiler_object_inline_coltitle_3558,JSCompiler_object_inline_marks_3552,1,n,i))}layoutGroup(view,group,_)});return shouldReflow(_.mark.group)?pulse.reflow():pulse}});exports.bound=Bound;exports.identifier=Identifier;exports.mark=Mark;exports.overlap=Overlap;exports.render=Render;exports.viewlayout=ViewLayout;Object.defineProperty(exports,"__esModule",{value:!0})})}
