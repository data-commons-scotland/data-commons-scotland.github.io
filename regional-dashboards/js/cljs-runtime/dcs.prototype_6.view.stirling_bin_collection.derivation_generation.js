...
dcs.prototype_6.view.stirling_bin_collection.derivation_generation.chart_spec = (function dcs$prototype_6$view$stirling_bin_collection$derivation_generation$chart_spec(title,data){
...
var household_waste_derivation_generation_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29560_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__29560_SHARP_,new cljs.core.Keyword(null,"region","region",270415120),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"region","region",270415120).cljs$core$IFn$_invoke$arity$1(p1__29560_SHARP_))," (all means)"].join(''));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29559_SHARP_){
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["Stirling",null,"Scotland",null], null), null),new cljs.core.Keyword(null,"region","region",270415120).cljs$core$IFn$_invoke$arity$1(p1__29559_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29558_SHARP_){
return (new cljs.core.Keyword(null,"year","year",335913393).cljs$core$IFn$_invoke$arity$1(p1__29558_SHARP_) >= ctx_min_year);
}),household_waste_derivation_generation)));
var household_waste_derivation_generation_SINGLEQUOTE__SINGLEQUOTE_ = cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__29563){
...
var region = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29564__$1,new cljs.core.Keyword(null,"region","region",270415120));
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29564__$1,new cljs.core.Keyword(null,"year","year",335913393));
var tonnes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29564__$1,new cljs.core.Keyword(null,"tonnes","tonnes",-913468653));
var quarterly_tonnes = (tonnes / (4));
var iter__4529__auto__ = (function dcs$prototype_6$view$stirling_bin_collection$derivation_generation$chart_$_iter__29566(s__29567){
return (new cljs.core.LazySeq(null,(function (){
var s__29567__$1 = s__29567;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__29567__$1);
if(temp__5735__auto__){
var s__29567__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29567__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__29567__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__29569 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__29568 = (0);
while(true){
if((i__29568 < size__4528__auto__)){
var quarter = cljs.core._nth(c__4527__auto__,i__29568);
cljs.core.chunk_append(b__29569,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"region","region",270415120),region,new cljs.core.Keyword(null,"year","year",335913393),year,new cljs.core.Keyword(null,"quarter","quarter",-508147616),quarter,new cljs.core.Keyword(null,"tonnes","tonnes",-913468653),quarterly_tonnes], null));

var G__29570 = (i__29568 + (1));
i__29568 = G__29570;
continue;
} else {
return true;
...
var stirling_bin_collection_derivation_generation_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29561_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__29561_SHARP_,new cljs.core.Keyword(null,"region","region",270415120),"Stirling (bin collection)");
...
var derivation_generation_SINGLEQUOTE__SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29562_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__29562_SHARP_,new cljs.core.Keyword(null,"date","date",-1463434462),dcs.prototype_6.util.date_str(new cljs.core.Keyword(null,"year","year",335913393).cljs$core$IFn$_invoke$arity$1(p1__29562_SHARP_),new cljs.core.Keyword(null,"quarter","quarter",-508147616).cljs$core$IFn$_invoke$arity$1(p1__29562_SHARP_)));
}),derivation_generation_SINGLEQUOTE_);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [oz.core.vega_lite,dcs.prototype_6.view.stirling_bin_collection.derivation_generation.chart_spec("Amount",derivation_generation_SINGLEQUOTE__SINGLEQUOTE_),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"actions","actions",-812656882),false], null)], null)], null);
});
