...
week:vegaTime.week,utcweek:vegaTime.utcweek,dayofyear:vegaTime.dayofyear,utcdayofyear:vegaTime.utcdayofyear,warn:warn,info:info,debug:debug,extent:vegaUtil.extent,inScope:inScope,intersect:function(b,opt,group){if(!b)return[];var $jscomp$destructuring$var86=$jscomp.makeIterator(b);b=$jscomp$destructuring$var86.next().value;$jscomp$destructuring$var86=$jscomp$destructuring$var86.next().value;b=(new vegaScenegraph.Bounds).set(b[0],b[1],$jscomp$destructuring$var86[0],$jscomp$destructuring$var86[1]);
