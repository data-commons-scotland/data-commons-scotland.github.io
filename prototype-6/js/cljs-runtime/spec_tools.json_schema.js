...
spec_tools.json_schema.accept_spec = (function (){var method_table__4654__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
var hierarchy__4658__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__42105 = cljs.core.get_global_hierarchy;
return (fexpr__42105.cljs$core$IFn$_invoke$arity$0 ? fexpr__42105.cljs$core$IFn$_invoke$arity$0() : fexpr__42105.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("spec-tools.json-schema","accept-spec"),spec_tools.json_schema.spec_dispatch,new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695),hierarchy__4658__auto__,method_table__4654__auto__,prefer_table__4655__auto__,method_cache__4656__auto__,cached_hierarchy__4657__auto__));
})();
}
...
var temp__5733__auto__ = (function (){var and__4149__auto__ = infer_titles_QMARK_(options);
...
var map__42110 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__42110__$1 = cljs.core.__destructure_map(map__42110);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42110__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42110__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42110__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42110__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__42111 = spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$1(form);
var map__42111__$1 = cljs.core.__destructure_map(map__42111);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42111__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__42112 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42112__$1)].join('')));
...
var vec__42113 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42113,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42113,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42113,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42113,(3),null);
...
var vec__42116 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42116,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42116,(1),null);
...
var extra_info = (function (){var G__42119 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
if(cljs.core.truth_((function (){var and__4149__auto__ = name;
if(cljs.core.truth_(and__4149__auto__)){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42119,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__42119;
}
})();
var or__4160__auto__ = new cljs.core.Keyword(null,"json-schema","json-schema",389191695).cljs$core$IFn$_invoke$arity$1(data);
