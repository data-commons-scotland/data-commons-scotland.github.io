...
return cljs.core.cons(cljs.core.first(s),(function (){var G__28134 = (n - (1));
var G__28135 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__28134,G__28135) : clojure.test.check.rose_tree.exclude_nth.call(null,G__28134,G__28135));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__28137 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__28137) : f.call(null,G__28137));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28136_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__28136_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__28136_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28143_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__28143_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__28143_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__28144_SHARP_){
var G__28145 = clojure.test.check.rose_tree.root(p1__28144_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__28145) : pred.call(null,G__28145));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4529__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__28146(s__28147){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__28152 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28152,(1),null);
var iterys__4525__auto__ = ((function (s__28147__$1,vec__28152,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__28146_$_iter__28148(s__28149){
return (new cljs.core.LazySeq(null,((function (s__28147__$1,vec__28152,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__28149__$1 = s__28149;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__28149__$1);
if(temp__5735__auto____$1){
var s__28149__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__28149__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__28149__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__28151 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__28150 = (0);
while(true){
if((i__28150 < size__4528__auto__)){
var child = cljs.core._nth(c__4527__auto__,i__28150);
cljs.core.chunk_append(b__28151,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__28214 = (i__28150 + (1));
i__28150 = G__28214;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28151),clojure$test$check$rose_tree$permutations_$_iter__28146_$_iter__28148(cljs.core.chunk_rest(s__28149__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28151),null);
}
} else {
var child = cljs.core.first(s__28149__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__28146_$_iter__28148(cljs.core.rest(s__28149__$2)));
}
} else {
return null;
}
...
});})(s__28147__$1,vec__28152,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__28147__$1,vec__28152,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,clojure$test$check$rose_tree$permutations_$_iter__28146(cljs.core.rest(s__28147__$1)));
} else {
var G__28215 = cljs.core.rest(s__28147__$1);
s__28147__$1 = G__28215;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28156_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__28156_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__28156_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28167_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__28167_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__28167_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__28168 = f;
var G__28169 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__28168,G__28169) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__28168,G__28169));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__28174 = f;
var G__28175 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__28174,G__28175) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__28174,G__28175));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
