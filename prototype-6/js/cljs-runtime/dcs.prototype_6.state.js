...
dcs.prototype_6.state.root = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"business-waste-by-region-derivation","business-waste-by-region-derivation",-1497440959),new cljs.core.Keyword(null,"ace-furniture-counts-derivation","ace-furniture-counts-derivation",-1567448318),new cljs.core.Keyword(null,"waste-site-derivation","waste-site-derivation",1441716515),new cljs.core.Keyword(null,"stirling-community-food-tonnes-derivation","stirling-community-food-tonnes-derivation",329935397),new cljs.core.Keyword(null,"stirling-bin-collection-derivation","stirling-bin-collection-derivation",1070247527),new cljs.core.Keyword(null,"fairshare-material-derivation","fairshare-material-derivation",-1925421910),new cljs.core.Keyword(null,"geojson","geojson",-719473398),new cljs.core.Keyword(null,"household-waste-derivation","household-waste-derivation",-738825683),new cljs.core.Keyword(null,"route-match","route-match",-1450985937),new cljs.core.Keyword(null,"fairshare-co2e-derivation","fairshare-co2e-derivation",1843243120),new cljs.core.Keyword(null,"region","region",270415120),new cljs.core.Keyword(null,"household-co2e-derivation","household-co2e-derivation",626105776),new cljs.core.Keyword(null,"ace-furniture-weights-derivation","ace-furniture-weights-derivation",-841951246),new cljs.core.Keyword(null,"meta-derivation","meta-derivation",-1841955659),new cljs.core.Keyword(null,"stirling-community-food-footfall-derivation","stirling-community-food-footfall-derivation",145481436)],[new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"generation","generation",-2132542044),null,new cljs.core.Keyword(null,"composition","composition",1834198617),null], null),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"orig","orig",-1678309870),null,new cljs.core.Keyword(null,"category-trends","category-trends",-1581889015),null,new cljs.core.Keyword(null,"item-trends","item-trends",-1085058419),null], null),null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"tonnes","tonnes",-913468653),null,new cljs.core.Keyword(null,"flow","flow",590489032),null], null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"generation","generation",-2132542044),null,new cljs.core.Keyword(null,"percent-recycled","percent-recycled",-587162431),null,new cljs.core.Keyword(null,"composition","composition",1834198617),null,new cljs.core.Keyword(null,"missed-bins","missed-bins",-732942122),null], null),null,null,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"generation","generation",-2132542044),null,new cljs.core.Keyword(null,"percent-recycled","percent-recycled",-587162431),null,new cljs.core.Keyword(null,"management","management",-516161795),null,new cljs.core.Keyword(null,"composition","composition",1834198617),null,new cljs.core.Keyword(null,"generation-positions","generation-positions",634586232),null,new cljs.core.Keyword(null,"percent-recycled-positions","percent-recycled-positions",1205146183),null], null),null,null,"Please select a region...",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"generation","generation",-2132542044),null,new cljs.core.Keyword(null,"generation-positions","generation-positions",634586232),null], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"orig","orig",-1678309870),null,new cljs.core.Keyword(null,"flights-worth","flights-worth",1635184208),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"per-category","per-category",509065434),null,new cljs.core.Keyword(null,"per-item","per-item",-606384115),null], null)], null),null,null]));
}
...
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.fairshare_material_derivation_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.fairshare_material_derivation_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fairshare-material-derivation","fairshare-material-derivation",-1925421910)], null));
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.fairshare_co2e_derivation_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.fairshare_co2e_derivation_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"fairshare-co2e-derivation","fairshare-co2e-derivation",1843243120)], null));
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_counts_derivation_orig_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_counts_derivation_orig_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ace-furniture-counts-derivation","ace-furniture-counts-derivation",-1567448318),new cljs.core.Keyword(null,"orig","orig",-1678309870)], null));
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_counts_derivation_category_trends_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_counts_derivation_category_trends_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ace-furniture-counts-derivation","ace-furniture-counts-derivation",-1567448318),new cljs.core.Keyword(null,"category-trends","category-trends",-1581889015)], null));
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_counts_derivation_item_trends_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_counts_derivation_item_trends_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ace-furniture-counts-derivation","ace-furniture-counts-derivation",-1567448318),new cljs.core.Keyword(null,"item-trends","item-trends",-1085058419)], null));
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_weights_derivation_orig_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_weights_derivation_orig_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ace-furniture-weights-derivation","ace-furniture-weights-derivation",-841951246),new cljs.core.Keyword(null,"orig","orig",-1678309870)], null));
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_weights_derivation_flights_per_category_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_weights_derivation_flights_per_category_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ace-furniture-weights-derivation","ace-furniture-weights-derivation",-841951246),new cljs.core.Keyword(null,"flights-worth","flights-worth",1635184208),new cljs.core.Keyword(null,"per-category","per-category",509065434)], null));
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_weights_derivation_flights_per_item_cursor !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_weights_derivation_flights_per_item_cursor = reagent.core.cursor(dcs.prototype_6.state.root,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ace-furniture-weights-derivation","ace-furniture-weights-derivation",-841951246),new cljs.core.Keyword(null,"flights-worth","flights-worth",1635184208),new cljs.core.Keyword(null,"per-item","per-item",-606384115)], null));
}
...
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.fairshare_material_holder !== 'undefined')){
} else {
dcs.prototype_6.state.fairshare_material_holder = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.fairshare_co2e_holder !== 'undefined')){
} else {
dcs.prototype_6.state.fairshare_co2e_holder = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_counts_holder !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_counts_holder = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_weights_holder !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_weights_holder = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
if((typeof dcs !== 'undefined') && (typeof dcs.prototype_6 !== 'undefined') && (typeof dcs.prototype_6.state !== 'undefined') && (typeof dcs.prototype_6.state.ace_furniture_to_waste_streams_holder !== 'undefined')){
} else {
dcs.prototype_6.state.ace_furniture_to_waste_streams_holder = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
