...
(isMulti={},unit$jscomp$0={},resolved[vl5?"vlPoint":"vlMulti"]="union"===op?(isMulti.or=name.reduce(function(acc,k){return acc.push.apply(acc,$jscomp.arrayFromIterable(multiRes[k])),acc},[]),isMulti):(unit$jscomp$0.and=name.map(function(k){var $jscomp$compprop19={};return $jscomp$compprop19.or=multiRes[k],$jscomp$compprop19}),unit$jscomp$0));return resolved};exports.selectionTest=function(name,datum,op){var data=this.context.data[name];name=data?data.values.value:[];data=data?data["index:unit"]&&
