...
var fexpr__40987 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__40987.cljs$core$IFn$_invoke$arity$1 ? fexpr__40987.cljs$core$IFn$_invoke$arity$1(type) : fexpr__40987.call(null,type));
});
...
var G__40990 = spec_tools.impl.normalize_symbol(x);
var G__40991 = null;
var G__40992 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__40990,G__40991,G__40992) : spec_tools.parse.parse_form.call(null,G__40990,G__40991,G__40992));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__40993 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__40994 = x;
var G__40995 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__40993,G__40994,G__40995) : spec_tools.parse.parse_form.call(null,G__40993,G__40994,G__40995));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__41045 = cljs.spec.alpha.form(x);
var G__41046 = options;
x = G__41045;
options = G__41046;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__40996 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__40997 = null;
var G__40998 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__40996,G__40997,G__40998) : spec_tools.parse.parse_form.call(null,G__40996,G__40997,G__40998));
} else {
...
var or__4160__auto__ = new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460).cljs$core$IFn$_invoke$arity$1(parse_data);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
var G__40999 = parse_data;
var G__40999__$1 = (((G__40999 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__40999));
var G__40999__$2 = (((G__40999__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__40999__$1));
var G__40999__$3 = (((G__40999__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__40999__$2));
var G__40999__$4 = (((G__40999__$3 == null))?null:cljs.core.seq(G__40999__$3));
if((G__40999__$4 == null)){
return null;
} else {
return cljs.core.set(G__40999__$4);
}
}
});
if((typeof spec_tools !== 'undefined') && (typeof spec_tools.parse !== 'undefined') && (typeof spec_tools.parse.parse_form !== 'undefined')){
} else {
spec_tools.parse.parse_form = (function (){var method_table__4654__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
var hierarchy__4658__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41002 = cljs.core.get_global_hierarchy;
...
return dispatch;
}),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850),hierarchy__4658__auto__,method_table__4654__auto__,prefer_table__4655__auto__,method_cache__4656__auto__,cached_hierarchy__4657__auto__));
})();
}
...
var map__41011 = spec_tools.impl.parse_keys(form);
var map__41011__$1 = cljs.core.__destructure_map(map__41011);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41011__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41011__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41011__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41011__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41011__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__41012 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__41012__$1 = (cljs.core.truth_((function (){var or__4160__auto__ = req;
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41012,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__41012);
if(cljs.core.truth_((function (){var or__4160__auto__ = opt;
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return opt_un;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41012__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__41012__$1;
}
}));
...
var vec__41013 = multi_spec_form;
var seq__41014 = cljs.core.seq(vec__41013);
var first__41015 = cljs.core.first(seq__41014);
var seq__41014__$1 = cljs.core.next(seq__41014);
var _ = first__41015;
var first__41015__$1 = cljs.core.first(seq__41014__$1);
var seq__41014__$2 = cljs.core.next(seq__41014__$1);
var multi_method_symbol = first__41015__$1;
var ___$1 = seq__41014__$2;
var form = vec__41013;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41016){
var vec__41017 = p__41016;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41017,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41017,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__41020_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__41020_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__41021_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__41021_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__41022_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__41022_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41023_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__41023_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__41024 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__41024__$1 = cljs.core.__destructure_map(map__41024);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41024__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__41025 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__41025__$1 = cljs.core.__destructure_map(map__41025);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41025__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__41029,options){
var vec__41030 = p__41029;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41030,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41030,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41030,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__41036,options){
...
var ___$1 = first__41039;
var values = seq__41038__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__41034_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__41034_SHARP_,options);
}),values);
...
var type_priority = (function (p1__41040_SHARP_){
var G__41043 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__41042 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__41040_SHARP_);
return (fexpr__41042.cljs$core$IFn$_invoke$arity$1 ? fexpr__41042.cljs$core$IFn$_invoke$arity$1(G__41043) : fexpr__41042.call(null,G__41043));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41041_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__41041_SHARP_,options);
}),cljs.core.rest(form))));
}));
