...
var vec__40588 = cljs.core.rest(expr);
...
var vec__40591 = first__40590;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40591,(0),null);
var form = seq__40589__$1;
...
var G__40594 = x;
var G__40594__$1 = (((G__40594 == null))?null:spec_tools.impl.polish(G__40594));
var G__40594__$2 = (((G__40594__$1 == null))?null:cljs.core.name(G__40594__$1));
if((G__40594__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__40594__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__40595 = x;
var G__40595__$1 = (((G__40595 == null))?null:cljs.core.name(G__40595));
if((G__40595__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__40595__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__40596){
var map__40597 = p__40596;
var map__40597__$1 = cljs.core.__destructure_map(map__40597);
var data = map__40597__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40597__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40597__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40597__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40597__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__40598){
var map__40599 = p__40598;
var map__40599__$1 = cljs.core.__destructure_map(map__40599);
var data = map__40599__$1;
...
var G__40600 = data;
var G__40600__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__40600,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__40600);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__40600__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__40600__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__40606 = form;
var G__40606__$1 = (((G__40606 == null))?null:cljs.core.rest(G__40606));
if((G__40606__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__40606__$1);
}
})();
var G__40607 = m;
var G__40607__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__40607,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__40601_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__40601_SHARP_)));
})):G__40607);
var G__40607__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__40607__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__40602_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__40602_SHARP_)));
})):G__40607__$1);
var G__40607__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__40607__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__40603_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__40603_SHARP_));
})):G__40607__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__40607__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__40608 = (function (){var G__40609 = form;
var G__40609__$1 = (((G__40609 == null))?null:cljs.core.rest(G__40609));
if((G__40609__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__40609__$1);
}
})();
var map__40608__$1 = cljs.core.__destructure_map(map__40608);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40608__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40608__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40608__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40608__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__40610 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__40610) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__40611 = form;
var G__40611__$1 = (((G__40611 == null))?null:cljs.core.seq(G__40611));
var G__40611__$2 = (((G__40611__$1 == null))?null:cljs.core.first(G__40611__$1));
if((G__40611__$2 == null)){
return null;
} else {
var fexpr__40612 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__40612.cljs$core$IFn$_invoke$arity$1 ? fexpr__40612.cljs$core$IFn$_invoke$arity$1(G__40611__$2) : fexpr__40612.call(null,G__40611__$2));
}
})():null));
});
/**
...
var len__4771__auto___40626 = arguments.length;
var i__4772__auto___40627 = (0);
while(true){
if((i__4772__auto___40627 < len__4771__auto___40626)){
args__4777__auto__.push((arguments[i__4772__auto___40627]));

var G__40628 = (i__4772__auto___40627 + (1));
i__4772__auto___40627 = G__40628;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq40613){
var self__4759__auto__ = this;
return self__4759__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40613));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__40614){
var vec__40615 = p__40614;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40615,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40615,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__40620){
var map__40621 = p__40620;
var map__40621__$1 = cljs.core.__destructure_map(map__40621);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40621__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40621__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40621__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40621__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__40618_SHARP_){
return cljs.core.map_QMARK_(p1__40618_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__40619_SHARP_){
return cljs.core.contains_QMARK_(p1__40619_SHARP_,x);
});
}),req_keys));
