...
var household_waste_derivation_generation_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43739_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__43739_SHARP_,new cljs.core.Keyword(null,"region","region",270415120),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"region","region",270415120).cljs$core$IFn$_invoke$arity$1(p1__43739_SHARP_))," (all means)"].join(''));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43738_SHARP_){
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["Stirling",null,"Scotland",null], null), null),new cljs.core.Keyword(null,"region","region",270415120).cljs$core$IFn$_invoke$arity$1(p1__43738_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__43737_SHARP_){
return (new cljs.core.Keyword(null,"year","year",335913393).cljs$core$IFn$_invoke$arity$1(p1__43737_SHARP_) >= ctx_min_year);
}),household_waste_derivation_generation)));
var household_waste_derivation_generation_SINGLEQUOTE__SINGLEQUOTE_ = cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__43742){
var map__43743 = p__43742;
var map__43743__$1 = cljs.core.__destructure_map(map__43743);
var region = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43743__$1,new cljs.core.Keyword(null,"region","region",270415120));
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43743__$1,new cljs.core.Keyword(null,"year","year",335913393));
var tonnes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43743__$1,new cljs.core.Keyword(null,"tonnes","tonnes",-913468653));
var quarterly_tonnes = (tonnes / (4));
var iter__4564__auto__ = (function dcs$prototype_6$view$stirling_bin_collection$derivation_generation$chart_$_iter__43744(s__43745){
return (new cljs.core.LazySeq(null,(function (){
var s__43745__$1 = s__43745;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__43745__$1);
if(temp__5735__auto__){
var s__43745__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43745__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__43745__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__43747 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__43746 = (0);
while(true){
if((i__43746 < size__4563__auto__)){
var quarter = cljs.core._nth(c__4562__auto__,i__43746);
cljs.core.chunk_append(b__43747,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"region","region",270415120),region,new cljs.core.Keyword(null,"year","year",335913393),year,new cljs.core.Keyword(null,"quarter","quarter",-508147616),quarter,new cljs.core.Keyword(null,"tonnes","tonnes",-913468653),quarterly_tonnes], null));

var G__43748 = (i__43746 + (1));
i__43746 = G__43748;
continue;
} else {
return true;
...
var stirling_bin_collection_derivation_generation_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43740_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__43740_SHARP_,new cljs.core.Keyword(null,"region","region",270415120),"Stirling (bin collection)");
...
var derivation_generation_SINGLEQUOTE__SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43741_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__43741_SHARP_,new cljs.core.Keyword(null,"date","date",-1463434462),dcs.prototype_6.util.date_str(new cljs.core.Keyword(null,"year","year",335913393).cljs$core$IFn$_invoke$arity$1(p1__43741_SHARP_),new cljs.core.Keyword(null,"quarter","quarter",-508147616).cljs$core$IFn$_invoke$arity$1(p1__43741_SHARP_)));
