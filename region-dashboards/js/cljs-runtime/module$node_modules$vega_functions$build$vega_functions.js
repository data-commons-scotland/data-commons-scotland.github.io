...
data.map(name):name(data)}function array(seq){return vegaUtil.isArray(seq)||ArrayBuffer.isView(seq)?seq:null}function sequence(seq){return array(seq)||(vegaUtil.isString(seq)?seq:null)}function join(seq,args){for(var $jscomp$restParams=[],$jscomp$restIndex=1;$jscomp$restIndex<arguments.length;++$jscomp$restIndex)$jscomp$restParams[$jscomp$restIndex-1]=arguments[$jscomp$restIndex];var $jscomp$spread$args0;return($jscomp$spread$args0=array(seq)).join.apply($jscomp$spread$args0,$jscomp.arrayFromIterable($jscomp$restParams))}
function indexof(seq,args){for(var $jscomp$restParams=[],$jscomp$restIndex=1;$jscomp$restIndex<arguments.length;++$jscomp$restIndex)$jscomp$restParams[$jscomp$restIndex-1]=arguments[$jscomp$restIndex];var $jscomp$spread$args1;return($jscomp$spread$args1=sequence(seq)).indexOf.apply($jscomp$spread$args1,$jscomp.arrayFromIterable($jscomp$restParams))}function lastindexof(seq,args){for(var $jscomp$restParams=[],$jscomp$restIndex=1;$jscomp$restIndex<arguments.length;++$jscomp$restIndex)$jscomp$restParams[$jscomp$restIndex-
1]=arguments[$jscomp$restIndex];var $jscomp$spread$args2;return($jscomp$spread$args2=sequence(seq)).lastIndexOf.apply($jscomp$spread$args2,$jscomp.arrayFromIterable($jscomp$restParams))}function slice(seq,args){for(var $jscomp$restParams=[],$jscomp$restIndex=1;$jscomp$restIndex<arguments.length;++$jscomp$restIndex)$jscomp$restParams[$jscomp$restIndex-1]=arguments[$jscomp$restIndex];var $jscomp$spread$args3;return($jscomp$spread$args3=sequence(seq)).slice.apply($jscomp$spread$args3,$jscomp.arrayFromIterable($jscomp$restParams))}
...
week:vegaTime.week,utcweek:vegaTime.utcweek,dayofyear:vegaTime.dayofyear,utcdayofyear:vegaTime.utcdayofyear,warn:warn,info:info,debug:debug,extent:vegaUtil.extent,inScope:inScope,intersect:function(b,opt,group){if(!b)return[];var $jscomp$destructuring$var80=$jscomp.makeIterator(b);b=$jscomp$destructuring$var80.next().value;$jscomp$destructuring$var80=$jscomp$destructuring$var80.next().value;b=(new vegaScenegraph.Bounds).set(b[0],b[1],$jscomp$destructuring$var80[0],$jscomp$destructuring$var80[1]);
