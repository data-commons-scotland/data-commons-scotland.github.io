...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_25550 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_25550(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_25551 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_25551(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_25556 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_25556(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_25559 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_25559(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_25560 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_25560(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_25563 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_25563(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_25566 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_25566(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_25576 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_25576(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_25580 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_25580(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_25585 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_25585(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_25586 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_25586(b);
}
});
