...
var i_25842 = (0);
while(true){
if((i_25842 < arr.length)){
(arr[i_25842] = null);

var G__25843 = (i_25842 + (1));
i_25842 = G__25843;
continue;
} else {
}
...
var i_25850 = (self__.level + (1));
while(true){
if((i_25850 <= (new_level + (1)))){
(update[i_25850] = self__.header);

var G__25851 = (i_25850 + (1));
i_25850 = G__25851;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_25852 = (update[i]).forward;
(x__$2.forward[i] = (links_25852[i]));
...
var i_25854 = (0);
while(true){
if((i_25854 <= self__.level)){
var links_25855 = (update[i_25854]).forward;
if((x__$1 === (((i_25854 < links_25855.length))?(links_25855[i_25854]):null))){
(links_25855[i_25854] = (x__$1.forward[i_25854]));

var G__25856 = (i_25854 + (1));
i_25854 = G__25856;
continue;
} else {
var G__25857 = (i_25854 + (1));
i_25854 = G__25857;
continue;
}
} else {
